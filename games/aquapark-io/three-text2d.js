        ...
        var s = i(0),
            ...
            h = function(t) {
                function e(e, i) {
                    ...
                    return n._align = new s.Vector2, n._font = i.font || "30px Arial", n._fillStyle = i.fillStyle || "#FFFFFF", n._shadowColor = i.shadowColor || "rgba(0, 0, 0, 0)", n._shadowBlur = i.shadowBlur || 0, n._shadowOffsetX = i.shadowOffsetX || 0, n._shadowOffsetY = i.shadowOffsetY || 0, n.canvas = new a.CanvasText, n.align = i.align || o.textAlign.center, n.side = i.side || s.DoubleSide, n.antialias = void 0 === i.antialias || i.antialias, n.text = e, n
                }
        ...
        var s = i(0),
            o = function(t) {
                ...
                return r(e, t), e.prototype.raycast = function() {
                    ...
                    this.sprite && (this.sprite.center.x = this._align.x * this.canvas.textWidth / this.canvas.width, this.sprite.center.y = 1 - (1 - this._align.y) * this.canvas.textHeight / this.canvas.height)
                }, Object.defineProperty(e.prototype, "align", {
                    set: function(t) {
                        this._align.copy(t), this._align.multiplyScalar(.5), this._align.addScalar(.5), this.updateAlign()
                    },
                    enumerable: !0,
                    configurable: !0
                }), e
