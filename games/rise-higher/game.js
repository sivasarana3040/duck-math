...
! function(b, c) {
    ...
    function j(b, c, d) {
        return p.isFunction(c) ? p.grep(b, function(b, aa) {
            return !!c.call(b, aa, b) !== d
    ...
    function A(b, c, d) {
        ...
        if (void 0 === d && 1 === b.nodeType)
            if (g = "data-" + c.replace(Hc, "-$&").toLowerCase(), d = b.getAttribute(g), "string" == typeof d) {
                try {
                    d = "true" ===
                        d || "false" !== d && ("null" === d ? null : d === +d + "" ? +d : Ic.test(d) ? JSON.parse(d) : d)
                } catch (l) {}
                qa.set(b, c, d)
            } else d = void 0;
        return d
    ...
    function B(b, c, d, g) {
        var l, r = 1,
            ...
            j = (p.cssNumber[c] || "px" !== s && +q) && mb.exec(p.css(b, c));
        if (j && j[3] !== s) {
            s = s || j[3];
            d = d || [];
            j = +q || 1;
            do r = r || ".5", j /= r, p.style(b, c, j + s); while (r !== (r = f() / q) && 1 !== r && --e)
        }
        return d && (j = +j || +q || 0, l = d[1] ? j + (d[1] + 1) * d[2] : +d[2], g && (g.unit = s, g.start = j,
            g.end = l)), l
    }

    function I(b, c) {
        for (var d, g, l = [], r = 0, e = b.length; r < e; r++)
            if (g = b[r], g.style)
                if (d = g.style.display, c) {
                    if ("none" === d && (l[r] = S.get(g, "display") || null, l[r] || (g.style.display = "")), "" === g.style.display && Ab(g)) {
                        ...
                        q = g.ownerDocument;
                        var j = g.nodeName;
                        q = (g = Yb[j]) ? g : (s = q.body.appendChild(q.createElement(j)), g = p.css(s, "display"), s.parentNode.removeChild(s), "none" === g && (g = "block"), Yb[j] = g, g);
                        d[f] = q
                    }
                } else "none" !== d && (l[r] = "none", S.set(g, "display", d));
        for (r = 0; r < e; r++) null != l[r] && (b[r].style.display =
            l[r]);
        return b
    }
    ...
    function G(b, c, d, g, l) {
        for (var r, e, f, q, s = c.createDocumentFragment(), j = [], m = 0, N = b.length; m < N; m++)
            if (r = b[m], r || 0 === r)
                if ("object" === p.type(r)) p.merge(j, r.nodeType ? [r] : r);
                else if (Jc.test(r)) {
            e =
            ...
            p.merge(j, e.childNodes);
            e = s.firstChild;
            e.textContent = ""
        } else j.push(c.createTextNode(r));
        s.textContent = "";
        for (m = 0; r = j[m++];)
            if (g && -1 < p.inArray(r, g)) l && l.push(r);
            else if (q = p.contains(r.ownerDocument, r), e = D(s.appendChild(r), "script"), q && x(e), d)
            for (f = 0; r = e[f++];) $b.test(r.type || "") && d.push(r);
        return s
    }
    ...
    function Q(b, c, d, g, l, r) {
        ...
        if (null == g && null == l ? (l = d, g = d = void 0) : null == l && ("string" == typeof d ? (l = g, g = void 0) : (l = g, g = d, d = void 0)), !1 === l) l = L;
        else if (!l) return b;
    ...
    function P(b, c) {
        ...
        if (1 === c.nodeType) {
            if (S.hasData(b) && (d = S.access(b), g = S.set(c, d), f = d.events))
                for (l in delete g.handle, g.events = {}, f) {
                    d = 0;
                    for (g = f[l].length; d < g; d++) p.event.add(c, l, f[l][d])
                }
            qa.hasData(b) && (r = qa.access(b), e = p.extend({}, r), qa.set(c, e))
        }
    }
    ...
    function ba(b, c,
        ...
        var r, e, f, s, q = 0,
            ...
            N = c[0],
            t = p.isFunction(N);
        if (t || 1 < j && "string" == typeof N && !da.checkClone && Lc.test(N)) return b.each(function(d) {
            var r = b.eq(d);
            t && (c[0] = N.call(this, d, r.html()));
            ba(r, c, g, l)
        });
        if (j && (r = G(c, b[0].ownerDocument, !1, b, l), e = r.firstChild, 1 === r.childNodes.length && (r = e), e || l)) {
            e = p.map(D(r, "script"), fa);
            for (f = e.length; q < j; q++) s = r, q !== m && (s = p.clone(s, !0, !0), f && p.merge(e, D(s, "script"))), g.call(b[q], s, q);
            if (f) {
                r = e[e.length - 1].ownerDocument;
                p.map(e, O);
                for (q = 0; q <
                    f; q++) s = e[q], $b.test(s.type || "") && !S.access(s, "globalEval") && p.contains(r, s) && (s.src ? p._evalUrl && p._evalUrl(s.src) : d(s.textContent.replace(Nc, ""), r))
            }
        }
        return b
    }
    ...
    function U(b, c, d) {
        for (var g = c ? p.filter(c, b) : b, l = 0; null != (c = g[l]); l++) d || 1 !== c.nodeType || p.cleanData(D(c)), c.parentNode && (d && p.contains(c.ownerDocument, c) && x(D(c, "script")), c.parentNode.removeChild(c));
        return b
    }

    function s(b, c, d) {
        var g, l, r, e, f = b.style;
        return d = d || Bb(b), d && (e = d.getPropertyValue(c) || d[c], "" !== e || p.contains(b.ownerDocument, b) ||
            (e = p.style(b, c)), !da.pixelMarginRight() && Qb.test(e) && ac.test(c) && (g = f.width, l = f.minWidth, r = f.maxWidth, f.minWidth = f.maxWidth = f.width = e, e = d.width, f.width = g, f.minWidth = l, f.maxWidth = r)), void 0 !== e ? e + "" : e
    }
    ...
    function F(b) {
        ...
        if (!c) {
            var c = p.cssProps,
                d;
            a: if (d = b, !(d in bc)) {
                for (var g = d[0].toUpperCase() + d.slice(1), l = cc.length; l--;)
                    if (d = cc[l] + g, d in bc) break a;
                d = void 0
            }
            c = c[b] = d || b
        }
    ...
    function Z(b, c, d) {
        var g, l = Bb(b),
            r = s(b, c, l),
            e = "border-box" === p.css(b, "boxSizing", !1,
                l);
    ...
    function l() {
        Cb && (!1 === X.hidden && b.requestAnimationFrame ? b.requestAnimationFrame(l) : b.setTimeout(l, p.fx.interval), p.fx.tick())
    }
    ...
    function K(b, c) {
        ...
        for (c = c ? 1 : 0; 4 > g; g +=
            2 - c) d = Sa[g], l["margin" + d] = l["padding" + d] = b;
        return c && (l.opacity = l.width = b), l
    }

    function r(b, c, d) {
        for (var g, l = (N.tweeners[c] || []).concat(N.tweeners["*"]), r = 0, e = l.length; r < e; r++)
            if (g = l[r].call(d, c, b)) return g
    }
    ...
    function N(b, c, d) {
        var g, l, e = 0,
            ...
            j = function() {
                if (l) return !1;
                for (var c = bb || q(), c = Math.max(0, m.startTime + m.duration - c), d = 1 - (c / m.duration || 0), g = 0, r = m.tweens.length; g < r; g++) m.tweens[g].run(d);
                return s.notifyWith(b, [m, d, c]), 1 > d && r ? c :
                    (r || s.notifyWith(b, [m, 1, 0]), s.resolveWith(b, [m]), !1)
            },
            m = s.promise({
                elem: b,
                props: p.extend({}, c),
                ...
                createTween: function(c, d) {
                    var g = p.Tween(b, m.opts, c, d, m.opts.specialEasing[c] || m.opts.easing);
                ...
                stop: function(c) {
                    ...
                    return c ? (s.notifyWith(b, [m, 1, 0]), s.resolveWith(b, [m, c])) : s.rejectWith(b, [m, c]), this
                }
            });
        c = m.props;
        ...
        var t, u, C, V;
        for (g in c)
            if (t = p.camelCase(g), u = d[t], C = c[g], Array.isArray(C) && (u = C[1], C = c[g] = C[0]), g !== t && (c[t] = C, delete c[g]), V = p.cssHooks[t], V && "expand" in V)
                for (g in C = V.expand(C), delete c[t], C) g in c || (c[g] = C[g], d[g] = u);
            else d[t] = u;
        for (; e < f; e++)
            if (g = N.prefilters[e].call(m, b, c, m.opts)) return p.isFunction(g.stop) && (p._queueHooks(m.elem, m.opts.queue).stop = p.proxy(g.stop, g)), g;
        return p.map(c, r, m), p.isFunction(m.opts.start) && m.opts.start.call(b,
            m), m.progress(m.opts.progress).done(m.opts.done, m.opts.complete).fail(m.opts.fail).always(m.opts.always), p.fx.timer(p.extend(j, {
            elem: b,
            anim: m,
            queue: m.opts.queue
        })), m
    ...
    function ka(b) {
        return function(c, d) {
            ...
            if (p.isFunction(d))
                for (; g = r[l++];) "+" === g[0] ? (g = g.slice(1) || "*", (b[g] = b[g] || []).unshift(d)) : (b[g] = b[g] || []).push(d)
        }
    }
    ...
    function na(b, c, d, g) {
        function l(f) {
            var s;
            return r[f] = !0, p.each(b[f] || [], function(b, aa) {
                var f = aa(c, d, g);
                return "string" != typeof f || e || r[f] ? e ? !(s = f) : void 0 : (c.dataTypes.unshift(f), l(f), !1)
            }), s
        }
        var r = {},
            e = b === Rb;
    ...
    function oa(b, c) {
        var d,
            g, l = p.ajaxSettings.flatOptions || {};
    ...
    p.extend = p.fn.extend = function() {
        var b, c, d, g, l, r, e = arguments[0] || {},
            f = 1,
            s = arguments.length,
            q = !1;
        "boolean" == typeof e && (q = e, e = arguments[f] || {}, f++);
        "object" == typeof e || p.isFunction(e) || (e = {});
        for (f === s && (e = this, f--); f < s; f++)
            if (null != (b = arguments[f]))
                for (c in b) d = e[c], g = b[c], e !== g && (q && g && (p.isPlainObject(g) || (l = Array.isArray(g))) ? (l ? (l = !1, r = d &&
                    Array.isArray(d) ? d : []) : r = d && p.isPlainObject(d) ? d : {}, e[c] = p.extend(q, r, g)) : void 0 !== g && (e[c] = g));
        return e
    };
    p.extend({
        ...
        isPlainObject: function(b) {
            ...
            return !(!b || "[object Object]" !==
                db.call(b)) && (!(c = Db(b)) || (d = La.call(c, "constructor") && c.constructor, "function" == typeof d && nb.call(d) === ob))
        },
        ...
        map: function(b, c, d) {
            ...
            if (e(b))
                for (g =
                    b.length; r < g; r++) l = c(b[r], r, d), null != l && f.push(l);
            else
                for (r in b) l = c(b[r], r, d), null != l && f.push(l);
            return ab.apply([], f)
        },
        guid: 1,
        proxy: function(b, c) {
    ...
    var za, eb = b,
        ca = function(b, c, d, g) {
            var l, r, e, f, s, q = c && c.ownerDocument,
                j = c ? c.nodeType : 9;
            if (d = d || [], "string" != typeof b || !b || 1 !== j && 9 !== j && 11 !== j) return d;
            if (!g && ((c ? c.ownerDocument || c : va) !== Y && wa(c), c = c || Y, la)) {
                if (11 !== j && (f = Pc.exec(b)))
                    if (l = f[1])
                        if (9 === j) {
                            ...
                            if (q && (r = q.getElementById(l)) && rb(c, r) && r.id === l) return d.push(r), d
                        }
                else {
                    if (f[2]) return Ma.apply(d, c.getElementsByTagName(b)),
                        d;
                ...
                if (ea.qsa && !Gb[b + " "] && (!ja || !ja.test(b))) {
                    if (1 !== j) q = c, s = b;
                        ...
                        s = r.join(",");
                        q = Sb.test(b) && fb(c.parentNode) || c
                    }
                    if (s) try {
                        return Ma.apply(d, q.querySelectorAll(s)), d
                    } catch (m) {} finally {
                        e === ia && c.removeAttribute("id")
                    }
                }
            }
            return gb(b.replace(Hb,
                "$1"), c, d, g)
        },
        hb = function() {
            function b(d, g) {
        ...
        Ua = function(b, c, d) {
            ...
            return c.first ? function(c, d, l) {
                for (; c = c[g];)
                    if (1 === c.nodeType || e) return b(c, d, l);
                return !1
            } : function(c, d, s) {
                var q, j, m, T = [Da, f];
                if (s)
                    for (; c = c[g];) {
                        ...
                        for (; c = c[g];)
                            if (1 === c.nodeType || e)
                                if (m = c[ia] || (c[ia] = {}), j = m[c.uniqueID] || (m[c.uniqueID] = {}), l && l === c.nodeName.toLowerCase()) c = c[g] || c;
                                else {
                                    if ((q = j[r]) && q[0] === Da && q[1] === f) return T[2] = q[2];
                                    if (j[r] = T, T[2] = b(c, d, s)) return !0
                                }
                return !1
            }
        },
        ...
        Oa = function(b, c, d, g, l) {
            for (var r, e = [], f = 0, s = b.length, q = null != c; f < s; f++)(r = b[f]) && (d && !d(r, g, l) || (e.push(r), q && c.push(f)));
            return e
        },
        Wa = function(b, c, d, g, l, r) {
            return g && !g[ia] && (g = Wa(g)), l && !l[ia] && (l = Wa(l, r)), pa(function(r, e, f, s) {
                var q, j, m = [],
                    N = [],
                    t = e.length,
                    p;
                if (!(p = r)) {
                    p = c || "*";
                    for (var u = f.nodeType ? [f] : f, C = [], V = 0, K = u.length; V < K; V++) ca(p, u[V], C);
                    p = C
                }
                p = !b || !r && c ? p : Oa(p, m, b, f, s);
                u = d ? l || (r ? b : t || g) ? [] : e : p;
                if (d && d(p, u, f, s), g) {
                    q = Oa(u, N);
                    g(q, [], f, s);
                    for (f = q.length; f--;)(j = q[f]) && (u[N[f]] = !(p[N[f]] = j))
                }
                if (r) {
                    if (l || b) {
                        if (l) {
                            q = [];
                            for (f = u.length; f--;)(j = u[f]) && q.push(p[f] = j);
                            l(null, u = [], q, s)
                        }
                        for (f = u.length; f--;)(j = u[f]) && -1 < (q = l ? Xa(r, j) :
                            m[f]) && (r[q] = !(e[q] = j))
                    }
                } else u = Oa(u === e ? u.splice(t, u.length) : u), l ? l(null, e, u, s) : Ma.apply(e, u)
            })
        },
        Ya = function(b) {
            var c, d, g, l = b.length,
                r = W.relative[b[0].type];
            d = r || W.relative[" "];
            for (var e = r ? 1 : 0, f = Ua(function(b) {
                ...
                if (d = W.relative[b[e].type]) q = [Ua(Va(q), d)];
                else {
                    if (d = W.filter[b[e].type].apply(null, b[e].matches), d[ia]) {
                        for (g = ++e; g < l && !W.relative[b[g].type]; g++);
        ...
        Ea, ea, W, Qa, jb, Na, Za, gb, Pa, xa, Fa, wa, Y, ma, la, ja, Aa, Ra, rb, ia = "sizzle" + 1 * new Date,
        va = eb.document,
        Da = 0,
        Rc = 0,
        fc = hb(),
    ...
    wa = ca.setDocument = function(b) {
        ...
        b = b ? b.ownerDocument || b :
            va;
        return b !== Y && 9 === b.nodeType && b.documentElement ? (Y = b, ma = Y.documentElement, la = !jb(Y), va !== Y && (d = Y.defaultView) && d.top !== d && (d.addEventListener ? d.addEventListener("unload", ic, !1) : d.attachEvent && d.attachEvent("onunload", ic)), ea.attributes = ra(function(b) {
            ...
            }), ea.getElementsByClassName = wb.test(Y.getElementsByClassName), ea.getById = ra(function(b) {
                return ma.appendChild(b).id =
                    ia, !Y.getElementsByName || !Y.getElementsByName(ia).length
                ...
                if ("undefined" != typeof c.getElementById &&
                    la) {
                    var d, g, l, aa = c.getElementById(b);
                    if (aa) {
                        if (d = aa.getAttributeNode("id"), d && d.value === b) return [aa];
                ...
                if ("*" === b) {
                    for (; d = aa[l++];) 1 === d.nodeType && g.push(d);
                    return g
                }
                return aa
            },
            ...
            }, Aa = [], ja = [], (ea.qsa = wb.test(Y.querySelectorAll)) && (ra(function(b) {
            ...
            ja = ja.length && RegExp(ja.join("|")), Aa = Aa.length && RegExp(Aa.join("|")), c = wb.test(ma.compareDocumentPosition), rb = c || wb.test(ma.contains) ? function(b, c) {
                ...
                return d ? d : (d = (b.ownerDocument || b) === (c.ownerDocument || c) ? b.compareDocumentPosition(c) : 1, 1 & d || !ea.sortDetached && c.compareDocumentPosition(b) === d ? b === Y || b.ownerDocument === va && rb(va, b) ? -1 : c === Y || c.ownerDocument === va && rb(va, c) ? 1 : xa ? Xa(xa, b) - Xa(xa, c) : 0 : 4 & d ? -1 : 1)
            } : function(b, c) {
                if (b === c) return Fa = !0, 0;
                var d, g = 0;
                d = b.parentNode;
                var l = c.parentNode,
                    aa = [b],
                    r = [c];
                if (!d || !l) return b === Y ? -1 : c === Y ? 1 : d ? -1 : l ? 1 : xa ? Xa(xa, b) - Xa(xa, c) : 0;
                if (d === l) return sb(b, c);
                for (d = b; d = d.parentNode;) aa.unshift(d);
                for (d = c; d = d.parentNode;) r.unshift(d);
                for (; aa[g] === r[g];) g++;
                return g ? sb(aa[g], r[g]) : aa[g] === va ? -1 : r[g] === va ? 1 : 0
            }, Y) : Y
    };
    ...
    ca.matchesSelector = function(b, c) {
        if ((b.ownerDocument || b) !== Y && wa(b), c = c.replace(Yc, "='$1']"), ea.matchesSelector && la && !Gb[c + " "] && (!Aa || !Aa.test(c)) && (!ja || !ja.test(c))) try {
            var d = Ra.call(b, c);
    ...
    ca.contains = function(b, c) {
        return (b.ownerDocument || b) !== Y && wa(b),
            rb(b, c)
    };
    ca.attr = function(b, c) {
        (b.ownerDocument || b) !== Y && wa(b);
        var d = W.attrHandle[c.toLowerCase()],
            d = d && Sc.call(W.attrHandle, c.toLowerCase()) ? d(b, c, !la) : void 0;
    ...
    ca.uniqueSort = function(b) {
        var c, d = [],
            g = 0,
            l = 0;
        if (Fa = !ea.detectDuplicates, xa = !ea.sortStable && b.slice(0),
            b.sort(Tb), Fa) {
    ...
    W = ca.selectors = {
        ...
        preFilter: {
            ...
            PSEUDO: function(b) {
                var c, d = !b[6] && b[2];
                return Jb.CHILD.test(b[0]) ? null : (b[3] ?
                    b[2] = b[4] || b[5] || "" : d && Zc.test(d) && (c = Na(d, !0)) && (c = d.indexOf(")", d.length - c) - d.length) && (b[0] = b[0].slice(0, c), b[2] = d.slice(0, c)), b.slice(0, 3))
            }
        },
        filter: {
            TAG: function(b) {
                ...
                return 1 === g && 0 === l ? function(b) {
                    ...
                    function(c, d, s) {
                        ...
                        if (u) {
                            ...
                            if (t = [e ? u.firstChild : u.lastChild], e && s) {
                                T = u;
                                m = T[ia] || (T[ia] = {});
                                j = m[T.uniqueID] || (m[T.uniqueID] = {});
                                q = j[b] || [];
                                C = (N = q[0] === Da && q[1]) && q[2];
                                for (T = N && u.childNodes[N]; T = ++N && T && T[d] || (C = N = 0) || t.pop();)
                                    if (1 === T.nodeType && ++C && T ===
                                        c) {
                                        j[b] = [Da, N, C];
                                        break
                                    }
                            } else if (s && (T = c, m = T[ia] || (T[ia] = {}), j = m[T.uniqueID] || (m[T.uniqueID] = {}), q = j[b] || [], N = q[0] === Da && q[1], C = N), !1 === C)
                                for (;
                                    (T = ++N && T && T[d] || (C = N = 0) || t.pop()) && (!(f ? T.nodeName.toLowerCase() === p : 1 === T.nodeType) || !++C || !(s && (m = T[ia] || (T[ia] = {}), j = m[T.uniqueID] || (m[T.uniqueID] = {}), j[b] = [Da, C]), T === c)););
            ...
            PSEUDO: function(b, c) {
                ...
                return g[ia] ? g(c) : 1 < g.length ? (d = [b,
                    b, "", c
                ], W.setFilters.hasOwnProperty(b.toLowerCase()) ? pa(function(b, d) {
                    for (var l, r = g(b, c), aa = r.length; aa--;) l = Xa(b, r[aa]), b[l] = !(d[l] = r[aa])
                }) : function(b) {
                    return g(b, 0, d)
                }) : g
            }
        ...
        pseudos: {
            not: pa(function(b) {
                var c = [],
                    d = [],
                    g = Za(b.replace(Hb, "$1"));
                return g[ia] ? pa(function(b, c, d, l) {
                    var r;
                    d = g(b, null, l, []);
            ...
            lang: pa(function(b) {
                return $c.test(b || "") || ca.error("unsupported lang: " + b), b = b.replace(Ga, Ha).toLowerCase(),
                    function(c) {
                        var d;
                        do
    ...
    vb.prototype = W.filters = W.pseudos;
    W.setFilters = new vb;
    Na = ca.tokenize = function(b, c) {
        ...
        for (s = W.preFilter; e;) {
            d && !(g = Wc.exec(e)) ||
                (g && (e = e.slice(g[0].length) || e), f.push(l = []));
            d = !1;
            (g = Xc.exec(e)) && (d = g.shift(), l.push({
                value: d,
                type: g[0].replace(Hb, " ")
            }), e = e.slice(d.length));
            for (r in W.filter) !(g = Jb[r].exec(e)) || s[r] && !(g = s[r](g)) || (d = g.shift(), l.push({
                value: d,
                type: r,
                matches: g
            }), e = e.slice(d.length));
    ...
    za = (Za = ca.compile = function(b, c) {
            ...
            var e = 0 < g.length,
                ...
                r = function(b, c, d, r, aa) {
                    var s, q, j, m = 0,
                        ...
                        u = Pa,
                        p = b || f && W.find.TAG("*", aa),
                        C = Da += null == u ? 1 : Math.random() || 0.1,
                        V = p.length;
                    for (aa && (Pa = c === Y || c || aa); N !== V && null != (s = p[N]); N++) {
                        if (f && s) {
                            q = 0;
                            for (c || s.ownerDocument === Y || (wa(s), d = !la); j = l[q++];)
                                if (j(s, c || Y, d)) {
                                    r.push(s);
                                    break
                                }
                    ...
                    if (m += N, e && N !== m) {
                        for (q = 0; j = g[q++];) j(T, t, c, d);
                        if (b) {
                            if (0 < m)
                                for (; N--;) T[N] || t[N] || (t[N] = Tc.call(r));
                            t = Oa(t)
                        }
                        Ma.apply(r, t);
                        aa && !b && 0 < t.length && 1 < m + g.length && ca.uniqueSort(r)
                    }
                    return aa &&
                        (Da = C, Pa = u), T
                },
        ...
        var l, r, e, f, s, q = "function" == typeof b && b,
            j = !g && Na(b = q.selector || b);
        if (d = d || [], 1 === j.length) {
            if (r = j[0] = j[0].slice(0), 2 < r.length && "ID" === (e = r[0]).type && 9 === c.nodeType && la && W.relative[r[1].type]) {
                if (c = (W.find.ID(e.matches[0].replace(Ga, Ha), c) || [])[0], !c) return d;
                q && (c = c.parentNode);
                b = b.slice(r.shift().value.length)
            }
            for (l = Jb.needsContext.test(b) ? 0 : r.length; l-- && !(e = r[l], W.relative[f = e.type]);)
                if ((s = W.find[f]) && (g =
                        s(e.matches[0].replace(Ga, Ha), Sb.test(r[0].type) && fb(c.parentNode) || c))) {
    ...
    }) || ib("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", function(b,
        c, d) {
        var g;
    ...
    (p.fn.init = function(b, c, d) {
        ...
        if (d = d || mc, "string" == typeof b) {
            if (g = "<" === b[0] && ">" === b[b.length - 1] && 3 <= b.length ? [null, b, null] : cd.exec(b), !g || !g[1] &&
                c) return !c || c.jquery ? (c || d).find(b) : this.constructor(c).find(b);
            if (g[1]) {
                if (c = c instanceof p ? c[0] : c, p.merge(this, p.parseHTML(g[1], c && c.nodeType ? c.ownerDocument || c : X, !0)), lc.test(g[1]) && p.isPlainObject(c))
                    for (g in c) p.isFunction(this[g]) ? this[g](c[g]) : this.attr(g, c[g]);
                return this
            }
            return l = X.getElementById(g[2]), l && (this[0] = l, this.length = 1), this
        }
    ...
    p.fn.extend({
            ...
            if (!kc.test(b))
                for (; g < l; g++)
                    for (d = this[g]; d && d !== c; d = d.parentNode)
                        if (11 > d.nodeType && (e ? -1 < e.index(d) : 1 === d.nodeType && p.find.matchesSelector(d, b))) {
                            r.push(d);
                            break
                        }
        ...
        index: function(b) {
            return b ?
                "string" == typeof b ? Ja.call(p(b), this[0]) : Ja.call(this, b.jquery ? b[0] : b) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function(b, c) {
    ...
    p.Callbacks = function(b) {
        ...
        var g, l, r, e, f = [],
            ...
            j = function() {
                e = e || b.once;
                for (r = g = !0; s.length; q = -1)
                    for (l = s.shift(); ++q < f.length;) !1 === f[q].apply(l[0],
                        l[1]) && b.stopOnFalse && (q = f.length, l = !1);
                b.memory || (l = !1);
                g = !1;
                e && (f = l ? [] : "")
            },
                                ...
                                var s = this,
                                    ...
                                    j = function() {
                                        ...
                                        if (!(c < f)) {
                                            ...
                                            p.isFunction(j) ? r ? j.call(b, e(f, d, m, r), e(f, d, g, r)) : (f++, j.call(b, e(f, d, m, r), e(f, d, g, r), e(f, d, m, d.notifyWith))) : (l !== m && (s = void 0, q = [b]), (r || d.resolveWith)(s, q))
                                        }
                                    },
                                    aa = r ? j : function() {
                                        try {
                                            ...
                                            p.Deferred.exceptionHook &&
                                                p.Deferred.exceptionHook(b, aa.stackTrace), c + 1 >= f && (l !== g && (s = void 0, q = [b]), d.rejectWith(s, q))
                                        }
                                    };
                                c ? aa() : (p.Deferred.getStackHook && (aa.stackTrace = p.Deferred.getStackHook()), b.setTimeout(aa))
                            }
                        }
                        var f = 0;
    ...
    p.extend({
        ...
        ready: function(b) {
            (!0 ===
                b ? --p.readyWait : p.isReady) || (p.isReady = !0, !0 !== b && 0 < --p.readyWait || Ub.resolveWith(X, [p]))
        }
    });
    ...
    var Ia = function(b, c, d, g, l, r, e) {
            var f = 0,
                ...
                q = null == d;
            if ("object" === p.type(d))
                for (f in l = !0, d) Ia(b, c, f, d[f], !0, r, e);
            else if (void 0 !== g && (l = !0, p.isFunction(g) || (e = !0), q && (e ? (c.call(b, g), c = null) : (q = c, c = function(b,
                    c, d) {
                    return q.call(p(b), d)
                })), c))
                for (; f < s; f++) c(b[f], d, e ? g : g.call(b[f], f, c(b[f], d)));
    ...
    p.fn.extend({
        data: function(b, c) {
            var d, g, l, r = this[0],
                e = r && r.attributes;
            if (void 0 === b) {
                if (this.length && (l = qa.get(r),
                        1 === r.nodeType && !S.get(r, "hasDataAttrs"))) {
            ...
            return "object" == typeof b ? this.each(function() {
                ...
                var d;
                if (r && void 0 === c) {
                    if ((d = qa.get(r, b), void 0 !== d) || (d = A(r, b), void 0 !== d)) return d
    ...
    sa.th = sa.td;
    var Jc = /<|&#?\w+;/,
        Lb = X.createDocumentFragment().appendChild(X.createElement("div")),
    ...
    p.event = {
        ...
        add: function(b, c, d, g, l) {
            ...
            if (q = S.get(b)) {
                ...
                c = (c || "").match(ta) || [""];
                for (q = c.length; q--;) f = qc.exec(c[q]) || [], t = u = f[1], f = (f[2] || "").split(".").sort(), t && (m = p.event.special[t] || {}, t = (l ? m.delegateType : m.bindType) || t, m = p.event.special[t] || {}, j = p.extend({
                    type: t,
                    origType: u,
                    data: g,
                    handler: d,
                    ...
                    namespace: f.join(".")
                }, r), (N = s[t]) || (N = s[t] = [], N.delegateCount = 0, m.setup && !1 !== m.setup.call(b, g, f, e) || b.addEventListener && b.addEventListener(t,
                    e)), m.add && (m.add.call(b, j), j.handler.guid || (j.handler.guid = d.guid)), l ? N.splice(N.delegateCount++, 0, j) : N.push(j), p.event.global[t] = !0)
            }
        },
        remove: function(b, c, d, g, l) {
            var r, e, f, s, q, j, m, N, t, u, C, V = S.hasData(b) && S.get(b);
            if (V && (s = V.events)) {
                c = (c || "").match(ta) || [""];
                for (q = c.length; q--;)
                    if (f = qc.exec(c[q]) || [], t = C = f[1], u = (f[2] || "").split(".").sort(), t) {
                        m = p.event.special[t] || {};
                        t = (g ? m.delegateType : m.bindType) || t;
                        N = s[t] || [];
                        f = f[2] && RegExp("(^|\\.)" + u.join("\\.(?:.*\\.|)") + "(\\.|$)");
                        for (e = r = N.length; r--;) j =
                            N[r], !l && C !== j.origType || d && d.guid !== j.guid || f && !f.test(j.namespace) || g && g !== j.selector && ("**" !== g || !j.selector) || (N.splice(r, 1), j.selector && N.delegateCount--, m.remove && m.remove.call(b, j));
                        e && !N.length && (m.teardown && !1 !== m.teardown.call(b, u, V.handle) || p.removeEvent(b, t, V.handle), delete s[t])
                    } else
                        for (t in s) p.event.remove(b, t + c[q], d, g, !0);
                p.isEmptyObject(s) && S.remove(b, "handle events")
            }
        },
        dispatch: function(b) {
            var c = p.event.fix(b),
                d, g, l, r, e, f, s = Array(arguments.length);
            ...
            if (c.delegateTarget = this, !q.preDispatch || !1 !== q.preDispatch.call(this, c)) {
                ...
                for (d = 0;
                    (r = f[d++]) && !c.isPropagationStopped();) {
                    c.currentTarget = r.elem;
                    for (g = 0;
                        (e = r.handlers[g++]) && !c.isImmediatePropagationStopped();) c.rnamespace && !c.rnamespace.test(e.namespace) || (c.handleObj = e, c.data = e.data, l = ((p.event.special[e.origType] || {}).handle || e.handler).apply(r.elem, s), void 0 !== l && !1 ===
                        (c.result = l) && (c.preventDefault(), c.stopPropagation()))
                }
    ...
    p.each({
        ...
        which: function(b) {
            var c = b.button;
            return null == b.which && gd.test(b.type) ? null != b.charCode ? b.charCode : b.keyCode : !b.which && void 0 !== c && hd.test(b.type) ?
    ...
    p.extend({
        ...
        clone: function(b, c, d) {
            ...
            return e = D(f, "script"), 0 < e.length && x(e, !q && D(b, "script")), f
        },
        cleanData: function(b) {
            for (var c, d, g, l = p.event.special, r = 0; void 0 !== (d = b[r]); r++)
                if (Kb(d)) {
                    if (c = d[S.expando]) {
                        if (c.events)
                            for (g in c.events) l[g] ? p.event.remove(d, g) : p.removeEvent(d, g, c.handle);
                        d[S.expando] = void 0
                    }
    ...
    var ac = /^margin/,
        ...
        rc, tc, uc, sc, Ob = X.createElement("div"),
        Ba = X.createElement("div");
    Ba.style && (Ba.style.backgroundClip = "content-box", Ba.cloneNode(!0).style.backgroundClip = "", da.clearCloneStyle = "content-box" === Ba.style.backgroundClip, Ob.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
        Ob.appendChild(Ba), p.extend(da, {
        ...
        style: function(b, c, d, g) {
            if (b && 3 !== b.nodeType && 8 !== b.nodeType && b.style) {
                ...
                return q || (c = F(f)), e = p.cssHooks[c] || p.cssHooks[f], void 0 === d ? e && "get" in e && void 0 !== (l = e.get(b, !1, g)) ? l : s[c] : (r = typeof d, "string" === r && (l = mb.exec(d)) && l[1] &&
                    (d = B(b, c, l), r = "number"), null != d && d === d && ("number" === r && (d += l && l[3] || (p.cssNumber[f] ? "" : "px")), da.clearCloneStyle || "" !== d || 0 !== c.indexOf("background") || (s[c] = "inherit"), e && "set" in e && void 0 === (d = e.set(b, d, g)) || (q ? s.setProperty(c, d) : s[c] = d)), void 0)
            }
        },
        css: function(b, c, d, g) {
            var l, r, e, f = p.camelCase(c);
            return vc.test(c) || (c = F(f)), e = p.cssHooks[c] || p.cssHooks[f], e && "get" in e && (l = e.get(b, !0, d)), void 0 === l && (l = s(b, c, g)), "normal" === l && c in wc && (l = wc[c]), "" === d || d ? (r = parseFloat(l), !0 === d || isFinite(r) ? r || 0 : l) :
                l
        }
    });
    p.each(["height", "width"], function(b, c) {
        p.cssHooks[c] = {
            get: function(b, d, g) {
                if (d) return !kd.test(p.css(b, "display")) || b.getClientRects().length && b.getBoundingClientRect().width ? Z(b, c, g) : oc(b, ld, function() {
                    return Z(b, c, g)
                })
            },
            set: function(b, d, g) {
    ...
    p.cssHooks.marginLeft = u(da.reliableMarginLeft, function(b, c) {
        if (c) return (parseFloat(s(b, "marginLeft")) ||
            b.getBoundingClientRect().left - oc(b, {
                marginLeft: 0
            }, function() {
    ...
    p.fn.extend({
        css: function(b, c) {
            return Ia(this, function(b, c, d) {
                ...
                if (Array.isArray(c)) {
                    d = Bb(b);
                    for (g = c.length; r < g; r++) l[c[r]] = p.css(b, c[r], !1,
                        d);
                    return l
                }
    ...
    p.Animation = p.extend(N, {
        ...
        tweener: function(b, c) {
            ...
            for (var d, g = 0, l = b.length; g < l; g++) d = b[g], N.tweeners[d] = N.tweeners[d] || [], N.tweeners[d].unshift(c)
        },
        prefilters: [function(b, c, d) {
            var g, l, e, f, q, s, j, m, N = "width" in c || "height" in c,
                t = this,
                u = {},
                C = b.style,
                V = b.nodeType && Ab(b),
            ...
            if (s = !p.isEmptyObject(c), s || !p.isEmptyObject(u))
                for (g in N && 1 === b.nodeType && (d.overflow = [C.overflow, C.overflowX, C.overflowY], j = K && K.display, null == j && (j = S.get(b, "display")), m = p.css(b, "display"), "none" === m && (j ? m = j : (I([b], !0), j = b.style.display ||
                        j, m = p.css(b, "display"), I([b]))), ("inline" === m || "inline-block" === m && null != j) && "none" === p.css(b, "float") && (s || (t.done(function() {
                        C.display = j
                    ...
                    })), s = !1, u) s || (K ? "hidden" in K && (V = K.hidden) : K = S.access(b, "fxshow", {
                    display: j
                }), e && (K.hidden = !V), V && I([b], !0), t.done(function() {
                    V || I([b]);
                    S.remove(b, "fxshow");
                    for (g in u) p.style(b,
                        g, u[g])
                })), s = r(V ? K[g] : 0, g, t), g in K || (K[g] = s.start, V && (s.end = s.start, s.start = 0))
        }],
        ...
        stop: function(b, c, d) {
            ...
            return "string" != typeof b && (d = c, c = b, b = void 0), c && !1 !== b && this.queue(b || "fx", []), this.each(function() {
                var c = !0,
                    ...
                    r = p.timers,
                    e = S.get(this);
                if (l) e[l] && e[l].stop && g(e[l]);
                else
                    for (l in e) e[l] && e[l].stop && nd.test(l) && g(e[l]);
    ...
    p.each(["toggle", "show", "hide"], function(b, c) {
        ...
        p.fn[c] = function(b, g, l) {
            return null == b || "boolean" == typeof b ? d.apply(this, arguments) : this.animate(K(c, !0), b, g, l)
        }
    });
    p.each({
        slideDown: K("show"),
    ...
    var lb = X.createElement("input"),
        od = X.createElement("select").appendChild(X.createElement("option"));
    lb.type = "checkbox";
    da.checkOn = "" !== lb.value;
    da.optSelected = od.selected;
    lb = X.createElement("input");
    lb.value = "t";
    lb.type = "radio";
    da.radioValue = "t" === lb.value;
    var xc, xb = p.expr.attrHandle;
    p.fn.extend({
        attr: function(b, c) {
            return Ia(this, p.attr, b,
    ...
    p.extend({
        attr: function(b, c, d) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return "undefined" == typeof b.getAttribute ? p.prop(b, c, d) : (1 === r && p.isXMLDoc(b) || (l = p.attrHooks[c.toLowerCase()] || (p.expr.match.bool.test(c) ? xc : void 0)), void 0 !== d ? null === d ? void p.removeAttr(b, c) : l && "set" in l && void 0 !== (g = l.set(b, d, c)) ? g : (b.setAttribute(c, d + ""), d) : l && "get" in l && null !== (g = l.get(b, c)) ? g : (g = p.find.attr(b, c), null ==
                g ? void 0 : g))
        },
        attrHooks: {
            type: {
    ...
    p.each(p.expr.match.bool.source.match(/\w+/g), function(b, c) {
        ...
        xb[c] = function(b, c, g) {
            var l, r, e = c.toLowerCase();
            return g || (r = xb[e],
                xb[e] = l, l = null != d(b, c, g) ? e : null, xb[e] = r), l
        }
    });
    ...
    p.extend({
        prop: function(b, c, d) {
            var g, l, r = b.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && p.isXMLDoc(b) || (c = p.propFix[c] || c, l = p.propHooks[c]), void 0 !== d ? l && "set" in l && void 0 !== (g = l.set(b, d, c)) ? g : b[c] = d : l && "get" in l && null !== (g = l.get(b,
                c)) ? g : b[c]
        },
        propHooks: {
            tabIndex: {
    ...
    p.fn.extend({
        addClass: function(b) {
            ...
            if ("string" == typeof b && b)
                for (c = b.match(ta) || []; d = this[f++];)
                    if (l = ga(d), g = 1 === d.nodeType && " " + V(l) + " ") {
        ...
        removeClass: function(b) {
            ...
            if ("string" == typeof b && b)
                for (c = b.match(ta) || []; d = this[f++];)
                    if (l = ga(d), g = 1 === d.nodeType && " " + V(l) + " ") {
                        for (e = 0; r = c[e++];)
                            for (; - 1 < g.indexOf(" " + r + " ");) g = g.replace(" " + r + " ", " ");
                        g = V(g);
                        l !== g && d.setAttribute("class", g)
                    }
            return this
        ...
        hasClass: function(b) {
            var c, d = 0;
            for (b = " " + b + " "; c = this[d++];)
                if (1 === c.nodeType && -1 < (" " + V(ga(c)) + " ").indexOf(b)) return !0;
            return !1
        }
    });
    var rd = /\r/g;
    p.fn.extend({
        val: function(b) {
            ...
            if (l) return c = p.valHooks[l.type] || p.valHooks[l.nodeName.toLowerCase()], c && "get" in c && void 0 !== (d = c.get(l, "value")) ? d : (d = l.value, "string" == typeof d ?
                d.replace(rd, "") : null == d ? "" : d)
        }
    });
    p.extend({
        valHooks: {
            ...
            select: {
                get: function(b) {
                    var c, d, g = b.options,
                        ...
                        e = r ? null : [],
                        s = r ? l + 1 : g.length;
                    for (d = 0 > l ? s : r ? l : 0; d < s; d++)
                        if (c = g[d], (c.selected || d === l) && !c.disabled && (!c.parentNode.disabled || !f(c.parentNode, "optgroup"))) {
                ...
                set: function(b, c) {
                    for (var d, g, l = b.options, r = p.makeArray(c), e = l.length; e--;) g =
                        l[e], (g.selected = -1 < p.inArray(p.valHooks.option.get(g), r)) && (d = !0);
    ...
    p.extend(p.event, {
        trigger: function(c, d, g, l) {
            var r, e, f, s, q, j, m, N = [g || X],
                t = La.call(c, "type") ? c.type : c;
            r = La.call(c, "namespace") ?
                c.namespace.split(".") : [];
            if (e = f = g = g || X, 3 !== g.nodeType && 8 !== g.nodeType && !yc.test(t + p.event.triggered) && (-1 < t.indexOf(".") && (r = t.split("."), t = r.shift(), r.sort()), q = 0 > t.indexOf(":") && "on" + t, c = c[p.expando] ? c : new p.Event(t, "object" == typeof c && c), c.isTrigger = l ? 2 : 3, c.namespace = r.join("."), c.rnamespace = c.namespace ? RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, c.result = void 0, c.target || (c.target = g), d = null == d ? [c] : p.makeArray(d, [c]), m = p.event.special[t] || {}, l || !m.trigger || !1 !== m.trigger.apply(g,
                    d))) {
                if (!l && !m.noBubble && !p.isWindow(g)) {
                    s = m.delegateType || t;
                    for (yc.test(s + t) || (e = e.parentNode); e; e = e.parentNode) N.push(e), f = e;
                    f === (g.ownerDocument || X) && N.push(f.defaultView || f.parentWindow || b)
                }
                for (r = 0;
                    (e = N[r++]) && !c.isPropagationStopped();) c.type = 1 < r ? s : m.bindType || t, (j = (S.get(e, "events") || {})[c.type] && S.get(e, "handle")) && j.apply(e, d), (j = q && e[q]) && j.apply && Kb(e) && (c.result = j.apply(e, d), !1 === c.result && c.preventDefault());
                return c.type = t, l || c.isDefaultPrevented() || m._default && !1 !== m._default.apply(N.pop(),
                    d) || !Kb(g) || q && p.isFunction(g[t]) && !p.isWindow(g) && (f = g[q], f && (g[q] = null), p.event.triggered = t, g[t](), p.event.triggered = void 0, f && (g[q] = f)), c.result
            }
        },
    ...
    p.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var b = this.type;
                return this.name &&
                    !p(this).is(":disabled") && td.test(this.nodeName) && !sd.test(b) && (this.checked || !pc.test(b))
            }).map(function(b, c) {
                var d = p(this).val();
        ...
        ajax: function(c, d) {
            function g(c, d, f, q) {
                ...
                if (!j) {
                    ...
                    if (f) {
                        F = u;
                        for (var n = H, y, A, Z, ha, B = F.contents, E = F.dataTypes;
                            "*" === E[0];) E.shift(), void 0 === y && (y = F.mimeType || n.getResponseHeader("Content-Type"));
                        if (y)
                            for (A in B)
                                if (B[A] && B[A].test(y)) {
                                    E.unshift(A);
                        ...
                        F = f = Z ? (Z !== E[0] && E.unshift(Z), f[Z]) : void 0
                    }
                    var oa;
                    a: {
                        f = u;y = F;A = H;Z = q;
                        var ka, G, na;F = {};n = f.dataTypes.slice();
                        if (n[1])
                            for (ka in f.converters) F[ka.toLowerCase()] = f.converters[ka];
                        for (ha = n.shift(); ha;)
                            if (f.responseFields[ha] && (A[f.responseFields[ha]] = y), !na && Z && f.dataFilter && (y = f.dataFilter(y, f.dataType)), na = ha, ha = n.shift())
                                if ("*" === ha) ha = na;
                                else if ("*" !==
                            na && na !== ha) {
                            if (ka = F[na + " " + ha] || F["* " + ha], !ka)
                                for (oa in F)
                                    if (G = oa.split(" "), G[1] === ha && (ka = F[na + " " + G[0]] || F["* " + G[0]])) {
                                        !0 === ka ? ka = F[oa] : !0 !== F[oa] && (ha = G[0], n.unshift(G[1]));
                                        break
                                    }
                            if (!0 !== ka)
                                if (ka && f["throws"]) y = ka(y);
                                else try {
                                    y = ka(y)
                                } catch (ua) {
                                    oa = {
                                        state: "parsererror",
                                        error: ka ? ua : "No conversion from " + na + " to " + ha
                                    };
                                    break a
                                }
                        }
                    ...
                    F = oa;
                    q ? (u.ifModified && (R = H.getResponseHeader("Last-Modified"), R && (p.lastModified[r] = R), R = H.getResponseHeader("etag"), R && (p.etag[r] = R)), 204 ===
                        c || "HEAD" === u.type ? ga = "nocontent" : 304 === c ? ga = "notmodified" : (ga = F.state, N = F.data, t = F.error, q = !t)) : (t = ga, !c && ga || (ga = "error", 0 > c && (c = 0)));
                    H.status = c;
                    H.statusText = (d || ga) + "";
                    q ? K.resolveWith(C, [N, ga, H]) : K.rejectWith(C, [H, ga, t]);
                    H.statusCode(z);
                    z = void 0;
                    m && V.trigger(q ? "ajaxSuccess" : "ajaxError", [H, u, q ? N : t]);
                    x.fireWith(C, [H, ga]);
                    m && (V.trigger("ajaxComplete", [H, u]), --p.active || p.event.trigger("ajaxStop"))
                }
            }
            "object" == typeof c && (d = c, c = void 0);
            d = d || {};
            var l, r, e, f, s, q, j, m, N, t, u = p.ajaxSetup({}, d),
                C = u.context ||
                u,
                ...
                H = {
                    ...
                    getResponseHeader: function(b) {
                        ...
                        if (j) {
                            if (!f)
                                for (f = {}; c = xd.exec(e);) f[c[1].toLowerCase()] = c[2];
                            c = f[b.toLowerCase()]
                        }
                    ...
                    setRequestHeader: function(b, c) {
                        return null == j && (b = R[b.toLowerCase()] = R[b.toLowerCase()] || b, F[b] = c), this
                    },
                    overrideMimeType: function(b) {
                        return null == j && (u.mimeType =
                            b), this
                    },
                    statusCode: function(b) {
                        var c;
                        if (b)
                            if (j) H.always(b[H.status]);
                            else
            ...
            if (K.promise(H), u.url = ((c || u.url || yb.href) + "").replace(zd, yb.protocol + "//"), u.type = d.method || d.type || u.method || u.type, u.dataTypes = (u.dataType || "*").toLowerCase().match(ta) || [""], null == u.crossDomain) {
                q = X.createElement("a");
                try {
                    q.href = u.url, q.href = q.href, u.crossDomain = Wb.protocol + "//" + Wb.host != q.protocol + "//" + q.host
                } catch (n) {
                    u.crossDomain = !0
                }
            }
            if (u.data && u.processData && "string" != typeof u.data && (u.data = p.param(u.data, u.traditional)), na(Bc, u, d, H), j) return H;
            (m = p.event && u.global) && 0 === p.active++ && p.event.trigger("ajaxStart");
            u.type = u.type.toUpperCase();
            u.hasContent = !yd.test(u.type);
            r = u.url.replace(vd, "");
            u.hasContent ? u.data && u.processData && 0 === (u.contentType || "").indexOf("application/x-www-form-urlencoded") && (u.data = u.data.replace(ud, "+")) : (t = u.url.slice(r.length), u.data && (r += (Vb.test(r) ? "&" : "?") + u.data, delete u.data), !1 === u.cache && (r =
                r.replace(wd, "$1"), t = (Vb.test(r) ? "&" : "?") + "_=" + zc++ + t), u.url = r + t);
            u.ifModified && (p.lastModified[r] && H.setRequestHeader("If-Modified-Since", p.lastModified[r]), p.etag[r] && H.setRequestHeader("If-None-Match", p.etag[r]));
            (u.data && u.hasContent && !1 !== u.contentType || d.contentType) && H.setRequestHeader("Content-Type", u.contentType);
            H.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + Cc + "; q=0.01" : "") : u.accepts["*"]);
            for (N in u.headers) H.setRequestHeader(N,
                u.headers[N]);
            if (u.beforeSend && (!1 === u.beforeSend.call(C, H, u) || j)) return H.abort();
            if (ga = "abort", x.add(u.complete), H.done(u.success), H.fail(u.error), l = na(Rb, u, d, H)) {
                if (H.readyState = 1, m && V.trigger("ajaxSend", [H, u]), j) return H;
                u.async && 0 < u.timeout && (s = b.setTimeout(function() {
                    H.abort("timeout")
                }, u.timeout));
                try {
                    j = !1, l.send(F, g)
    ...
    p.ajaxPrefilter("json jsonp", function(c, d, g) {
        var l, r, e, f = !1 !== c.jsonp && (Xb.test(c.url) ? "url" : "string" == typeof c.data && 0 === (c.contentType || "").indexOf("application/x-www-form-urlencoded") && Xb.test(c.data) && "data");
        if (f || "jsonp" === c.dataTypes[0]) return l = c.jsonpCallback = p.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, f ? c[f] = c[f].replace(Xb, "$1" + l) : !1 !== c.jsonp && (c.url += (Vb.test(c.url) ? "&" : "?") + c.jsonp +
            "=" + l), c.converters["script json"] = function() {
    ...
    var Bd = da,
        Ec, Fc = X.implementation.createHTMLDocument("").body;
    ...
    p.parseHTML = function(b, c, d) {
        ...
        var g, l, r;
        return c || (da.createHTMLDocument ? (c = X.implementation.createHTMLDocument(""), g = c.createElement("base"), g.href = X.location.href, c.head.appendChild(g)) : c = X), l = lc.exec(b), r = !d && [], l ? [c.createElement(l[1])] : (l = G([b], c, r), r && r.length && p(r).remove(), p.merge([], l.childNodes))
    };
    p.fn.load = function(b, c, d) {
        var g, l, r, e = this,
            f = b.indexOf(" ");
        return -1 < f && (g = V(b.slice(f)), b = b.slice(0, f)), p.isFunction(c) ? (d = c, c = void 0) : c && "object" == typeof c && (l = "POST"), 0 <
            e.length && p.ajax({
                url: b,
                type: l || "GET",
                dataType: "html",
    ...
    p.offset = {
        setOffset: function(b,
            c, d) {
            var g, l, r, e, f, q, s = p.css(b, "position"),
                j = p(b),
                m = {};
    ...
    p.each({
        ...
        p.fn[b] = function(g) {
            return Ia(this, function(b, g, l) {
                var r;
                return p.isWindow(b) ? r = b : 9 === b.nodeType &&
                    (r = b.defaultView), void 0 === l ? r ? r[c] : b[g] : void(r ? r.scrollTo(d ? r.pageXOffset : l, d ? l : r.pageYOffset) : b[g] = l)
            }, b, g, arguments.length)
        }
    });
    p.each(["top", "left"], function(b, c) {
        p.cssHooks[c] = u(da.pixelPosition, function(b, d) {
        ...
        if (b && b.canPlayType && !1 === this.settings.useFlash) {
            for (var c = [{
                ...
                if (e = c[f].e, c[f].m.length && "object" === typeof c[f].m)
                    for (var n = 0, m = c[f].m.length; n < m; n++)
...
(function() {
    ...
    d.prototype = {
                ...
                for (var d = 0; d < this._src.length; d++) {
                    ...
                    if (this._format && this._format[d]) m = this._format[d];
                        ...
                        if ("string" !== typeof y) {
                            ...
                            continue
                        }(m = /^data:audio\/([^;,]+);/i.exec(y)) || (m = /\.([^.]+)$/.exec(y.split("?", 1)[0]));
                        m && (m = m[1].toLowerCase())
                    }
        ...
        play: function(b, d) {
            ...
            var x = Math.max(0, 0 < n._seek ? n._seek : e._sprite[b][0] / 1E3),
                G = Math.max(0, (e._sprite[b][0] + e._sprite[b][1]) / 1E3 - x),
            ...
            if (e._webAudio) f = function() {
                ...
                "undefined" === typeof L.bufferSource.start ? n._loop ? L.bufferSource.noteGrainOn(0, x, 86400) : L.bufferSource.noteGrainOn(0, x, G) : n._loop ? L.bufferSource.start(0, x, 86400) : L.bufferSource.start(0,
                    x, G);
            ...
            for (var m = j._getSoundIds(f), n = 0; n < m.length; n++) {
                ...
                if (D) {
                    ...
                    if (j._webAudio && !D._muted) {
                        var x = c.ctx.currentTime,
                            G = x + e / 1E3;
                        D._volume = b;
                        D._node.gain.setValueAtTime(b, x);
                        D._node.gain.linearRampToValueAtTime(d,
                            G)
                    }
                    j._startFadeInterval(D, b, d, e, m[n], "undefined" === typeof f)
                }
            }
            return j
        },
        _startFadeInterval: function(b, c, d, e, f, j) {
            ...
            b._interval = setInterval(function() {
                ...
                j && (m._volume = n);
                if (d < c && n <= d || d > c && n >= d) clearInterval(b._interval), b._interval = null, b._fadeTo = null, m.volume(d, b._id),
                    m._emit("fade", b._id)
            }, f)
        },
...
(function() {
    ...
    HowlerGlobal.prototype.orientation = function(b, c, d, e, g, t) {
        ...
        if ("number" === typeof b) this._orientation = [b, c, d, e, g, t], "undefined" !== typeof this.ctx.listener.forwardX ? (this.ctx.listener.forwardX.setTargetAtTime(b, Howler.ctx.currentTime, 0.1), this.ctx.listener.forwardY.setTargetAtTime(c, Howler.ctx.currentTime, 0.1), this.ctx.listener.forwardZ.setTargetAtTime(d, Howler.ctx.currentTime, 0.1), this.ctx.listener.upX.setTargetAtTime(b, Howler.ctx.currentTime,
            0.1), this.ctx.listener.upY.setTargetAtTime(c, Howler.ctx.currentTime, 0.1), this.ctx.listener.upZ.setTargetAtTime(d, Howler.ctx.currentTime, 0.1)) : this.ctx.listener.setOrientation(b, c, d, e, g, t);
        else return z;
        return this
    };
    ...
    Howl.prototype.pos = function(b, c, d, m) {
        ...
        for (var t = g._getSoundIds(m), z = 0; z < t.length; z++) {
            var y = g._soundById(t[z]);
            if (y)
                if ("number" === typeof b) y._pos = [b, c, d], y._node && ((!y._panner || y._panner.pan) && e(y, "spatial"), y._panner.positionX.setValueAtTime(b, Howler.ctx.currentTime), y._panner.positionY.setValueAtTime(c,
    ...
    Howl.prototype.orientation = function(b, c, d, m) {
        ...
        for (var t = g._getSoundIds(m), z = 0; z < t.length; z++) {
            var y = g._soundById(t[z]);
            if (y)
                if ("number" === typeof b) y._orientation = [b, c, d], y._node && (y._panner || (y._pos || (y._pos = g._pos || [0, 0, -0.5]), e(y, "spatial")), y._panner.orientationX.setValueAtTime(b, Howler.ctx.currentTime), y._panner.orientationY.setValueAtTime(c, Howler.ctx.currentTime), y._panner.orientationZ.setValueAtTime(d, Howler.ctx.currentTime)), g._emit("orientation", y._id);
...
(function(b) {
    ...
    b.ig = {
        ...
        getImagePixels: function(b, c, d, e, f) {
            ...
            var D = b.width / I,
                x = b.height / I;
            j.width = Math.ceil(D);
            j.height = Math.ceil(x);
            n.drawImage(b, 0, 0, D, x);
    ...
    b.ig.Class.extend = function(c) {
        ...
        var z = new this;
        e = !1;
        for (var y in c) z[y] = "function" == typeof c[y] && "function" == typeof t[y] && f.test(c[y]) ? function(b, c) {
            return function() {
                var d = this.parent;
                this.parent = t[b];
...
ig.module("impact.image").defines(function() {
    ig.Image = ig.Class.extend({
        ...
        resize: function(b) {
            ...
            f.width = d;
            f.height = e;
            for (var j = f.getContext("2d"), n = j.getImageData(0, 0, d, e), m = 0; m < e; m++)
                for (var g = 0; g < d; g++) {
                    var t = 4 * (Math.floor(m / b) * this.width + Math.floor(g / b)),
                        z = 4 * (m * d + g);
                    n.data[z] = c.data[t];
                    n.data[z + 1] = c.data[t + 1];
                    n.data[z + 2] = c.data[t + 2];
                    n.data[z + 3] = c.data[t + 3]
                }
        ...
        drawTile: function(b, c, d, e, f, j, n) {
            ...
            if (this.loaded && !(e > this.width || f > this.height)) {
                ...
                ig.system.context.drawImage(this.data, Math.floor(d * e) % this.width * m, Math.floor(d * e / this.width) * f * m, g, t, ig.system.getDrawPos(b) * z - (j ? g : 0), ig.system.getDrawPos(c) * y - (n ? t : 0), g, t);
                (j ||
...
ig.module("impact.collision-map").requires("impact.map").defines(function() {
    ig.CollisionMap = ig.Map.extend({
        ...
        trace: function(b, c, f, j, n, m) {
            ...
            if (1 < t)
                for (var z = f / t, y = j / t, A = 0; A < t && (z || y) && !(this._traceStep(g,
                        b, c, z, y, n, m, f, j, A), b = g.pos.x, c = g.pos.y, g.collision.x && (f = z = 0), g.collision.y && (j = y = 0), g.collision.slope); A++);
            else this._traceStep(g, b, c, f, j, n, m, f, j, 0);
            return g
        },
        _traceStep: function(b, c, f, j, n, m, g, t, z, y) {
            b.pos.x += j;
            b.pos.y += n;
            var A = 0;
            if (j) {
                ...
                var x = Math.floor((c + B) / this.tilesize);
                if (0 < y || j == x || 0 > x || x >= this.width) x = -1;
                if (0 <= j && j < this.width)
                    for (var G =
                            A; G < D && !(-1 != x && (A = this.data[G][x], 1 < A && A <= this.lastSlope && this._checkTileDef(b, A, c, f, t, z, m, g, x, G))); G++)
                        if (A = this.data[G][j], 1 == A || A > this.lastSlope || 1 < A && this._checkTileDef(b, A, c, f, t, z, m, g, j, G)) {
            ...
            if (n) {
                ...
                if (0 <= G && G < this.height)
                    for (j = A; j < I && !(-1 != D && (A = this.data[D][j], 1 < A && A <= this.lastSlope && this._checkTileDef(b, A, c, f, t, z, m, g, j, D))); j++)
                        if (A = this.data[G][j], 1 == A || A > this.lastSlope || 1 < A && this._checkTileDef(b, A, c, f, t, z, m, g, j, G)) {
                            if (1 < A && A <= this.lastSlope && b.collision.slope) break;
                            b.collision.y = !0;
                            b.tile.y = A;
        ...
        _checkTileDef: function(b, c, f, j, n, m, g, t, z, y) {
            ...
            var B = (A[3] - A[1]) * this.tilesize,
                I = A[4];
            g = f + n + (0 > B ? g : 0) - (z + A[0]) * this.tilesize;
            t = j + m + (0 < c ? t : 0) - (y + A[1]) * this.tilesize;
            if (0 < c * t - B * g) {
                ...
                var D = g * y + t * z,
                    A = y * D,
                    D = z * D;
                if (A * A + D * D >= n * n + m * m) return I || 0.5 > c * (t - m) - B * (g - n);
                b.pos.x = f + n - A;
                b.pos.y = j + m - D;
                b.collision.slope = {
                    x: c,
...
ig.module("impact.background-map").requires("impact.map", "impact.image").defines(function() {
    ig.BackgroundMap = ig.Map.extend({
            ...
            for (e = 0; e < f; e++)
                for (var t = 0; t < j; t++)
                    if (e + b < this.width && t + c < this.height) {
                        var z = this.data[t + c][e + b];
                        z && this.tiles.drawTile(e * this.tilesize - n, t * this.tilesize - m, z - 1, this.tilesize)
                    }
            ig.system.context = d;
            return g
        },
        ...
        drawPreRendered: function() {
            ...
            for (var g = 0; e < j; e++) {
                for (var t = 0, z = d; z < f; z++) {
                    var y = this.preRenderedChunks[e % m][z % n],
                        A = -b + z * this.chunkSize - t,
                    ...
                    this.repeat && y.width < this.chunkSize && A + y.width < ig.system.realWidth && (t += this.chunkSize - y.width, f++)
                }
        ...
        drawTiled: function() {
            for (var b = 0, c = null, d = (this.scroll.x / this.tilesize).toInt(),
                    e = (this.scroll.y / this.tilesize).toInt(), f = this.scroll.x % this.tilesize, j = this.scroll.y % this.tilesize, n = -f - this.tilesize, f = ig.system.width + this.tilesize - f, m = ig.system.height + this.tilesize - j, g = -1, j = -j - this.tilesize; j < m; g++, j += this.tilesize) {
                var t = g + e;
                if (t >= this.height || 0 > t) {
                    if (!this.repeat) continue;
                    t = (t % this.height + this.height) % this.height
                }
                for (var z = -1, y = n; y < f; z++, y += this.tilesize) {
                    b = z + d;
                    if (b >= this.width || 0 > b) {
                        if (!this.repeat) continue;
        ...
        checkEntities: function() {
            for (var b = {}, c = 0; c < this.entities.length; c++) {
                ...
                if (!(d.type == ig.Entity.TYPE.NONE && d.checkAgainst == ig.Entity.TYPE.NONE && d.collides == ig.Entity.COLLIDES.NEVER))
                    for (var e = {}, f = Math.floor(d.pos.y / this.cellSize), j = Math.floor((d.pos.x + d.size.x) / this.cellSize) + 1, n = Math.floor((d.pos.y + d.size.y) / this.cellSize) + 1, m = Math.floor(d.pos.x / this.cellSize); m < j; m++)
                        for (var g = f; g < n; g++)
                            if (b[m])
                                if (b[m][g]) {
                                    for (var t = b[m][g], z = 0; z < t.length; z++) d.touches(t[z]) && !e[t[z].id] && (e[t[z].id] = !0, ig.Entity.checkPair(d, t[z]));
                                    t.push(d)
                                } else b[m][g] = [d];
                else b[m] = {}, b[m][g] = [d]
            }
...
ig.module("plugins.audio.sound-info").defines(function() {
    SoundInfo = ig.Class.extend({
        ...
        sfx: {
            ...
            button: {
                path: "media/audio/games/button"
            },
            over: {
                path: "media/audio/games/over"
            },
            win: {
                path: "media/audio/games/win"
            },
            lose: {
                path: "media/audio/games/lose"
            },
            openingSound: {
...
ig.module("plugins.splash-loader").requires("impact.loader", "impact.animation").defines(function() {
    ig.SplashLoader = ig.Loader.extend({
        ...
        splash: new ig.Image("media/graphics/games/ui/cover.png"),
        loadingbar0: new ig.Image("media/graphics/games/ui/loading-bar0.png"),
        loadingbar1: new ig.Image("media/graphics/games/ui/loading-bar1.png"),
        init: function(b, c) {
            this.parent(b, c);
        ...
        draw: function() {
            ...
            if (!(0.15 > this._drawStatus)) {
                ...
                var b, c, d;
                b = this.loadingbar0.width;
                w2 = this.loadingbar1.width;
                c = this.loadingbar0.height;
                h2 = this.loadingbar1.height;
                d = 0.5 * ig.system.width - b / 2;
                b = (b - w2) / 2;
                c = (c - h2) / 2;
                this.splash.draw(0, 0);
                this.loadingbar0.draw(d,
                    380);
                0.96 <= this._drawStatus && (this._drawStatus = 1);
                ig.system.context.drawImage(this.loadingbar1.data, 0, 0, w2 * this._drawStatus, h2, d + b, 380 + c, w2 * this._drawStatus, h2);
                ig.system.context.fillStyle = "#FFFFFF";
                ig.system.context.textAlign = "center";
                ig.system.context.font = "22pt mainfont";
                ig.system.context.fillText(_STRINGS.Splash.Loading, ig.system.width / 2, 450)
            }
        },
        tapToStartDiv: function(b) {
            this.desktopCoverDIV = document.createElement("div");
            this.desktopCoverDIV.id = this.desktopCoverDIVID;
            this.desktopCoverDIV.setAttribute("class",
                "play");
...
ig.module("plugins.tweens-handler").requires("impact.entity", "plugins.tween", "plugins.patches.entity-patch").defines(function() {
    ...
    ig.Tween.Interpolation = {
        ...
        Bezier: function(b, d) {
            for (var e = 0, f = b.length - 1, j = Math.pow, n = ig.Tween.Interpolation.Utils.Bernstein, m = 0; m <= f; m++) e += j(1 - d, f - m) * j(d, m) * b[m] * n(f, m);
            return e
        },
    ...
    ig.Entity.inject({
        ...
        setScale: function(b, c) {
            ...
            var f = this.scale.x / ig.system.scale,
                j = this.scale.y / ig.system.scale,
                n = d * f,
                m = e * j;
            this.size.x = 0 <= n ? n : -n;
            this.size.y = 0 <= m ? m : -m;
            this.pos.x = 0 < n ? this.pos.x + (d - n) * this.anchor.x : this.pos.x + ((d - n) * this.anchor.x - n);
            this.pos.y = 0 < m ? this.pos.y + (e - m) * this.anchor.y : this.pos.y + ((d - m) * this.anchor.y - m);
            for (var g in this.anims) this.anims[g].flip.x = 0 > f ? !0 : !1, this.anims[g].flip.y = 0 > j ? !0 : !1
        },
...
ig.module("plugins.fullscreen").requires("impact.entity").defines(function() {
        ...
        resize: function() {
            ...
            for (c in b) {
                var d = Math.min(ig.sizeHandler.scaleRatioMultiplier.x, ig.sizeHandler.scaleRatioMultiplier.y),
                    ...
                    t = ig.domHandler.getOffsets(g);
                ig.ua.mobile ? (g = t.left, t = t.top, ig.sizeHandler.disableStretchToFitOnMobileFlag ? (f = Math.floor(g + f * ig.sizeHandler.scaleRatioMultiplier.x) + "px", j = Math.floor(t + j * ig.sizeHandler.scaleRatioMultiplier.y) +
    ...
    ig.FullscreenButton = ig.Entity.extend({
        ...
        createClickableOutboundLayer: function() {
            ...
            } else j = ig.domHandler.getElementById("#canvas"), j = ig.domHandler.getOffsets(j), n = j.left, m = j.top, ig.sizeHandler.enableStretchToFitOnDesktopFlag ? (j = Math.floor(n + this.pos.x * ig.sizeHandler.sizeRatio.x) + "px", m = Math.floor(m + this.pos.y * ig.sizeHandler.sizeRatio.y) + "px", n = Math.floor(this.size.x * ig.sizeHandler.sizeRatio.x) + "px", c = Math.floor(this.size.y * ig.sizeHandler.sizeRatio.y) + "px") : (j =
                Math.floor(n + this.pos.x * c) + "px", m = Math.floor(m + this.pos.y * c) + "px", n = Math.floor(this.size.x * c) + "px", c = Math.floor(this.size.y * c) + "px");
            ig.domHandler.css(d, {
                "float": "left",
                position: "absolute",
                left: j,
        ...
        createClickableOutboundLayer: function(b, c, d, e) {
            ...
            if (ig.ua.mobile) {
                ...
                ig.sizeHandler.disableStretchToFitOnMobileFlag ? (e = Math.floor(n + this.pos.x * ig.sizeHandler.scaleRatioMultiplier.x) + "px", m = Math.floor(m + this.pos.y * ig.sizeHandler.scaleRatioMultiplier.y) + "px", n = Math.floor(this.size.x * ig.sizeHandler.scaleRatioMultiplier.x) + "px", d = Math.floor(this.size.y * ig.sizeHandler.scaleRatioMultiplier.y) + "px") : (e = Math.floor(this.pos.x *
                    ig.sizeHandler.sizeRatio.x) + "px", m = Math.floor(this.pos.y * ig.sizeHandler.sizeRatio.y) + "px", n = Math.floor(this.size.x * ig.sizeHandler.sizeRatio.x) + "px", d = Math.floor(this.size.y * ig.sizeHandler.sizeRatio.y) + "px")
            } else e = ig.domHandler.getElementById("#canvas"), e = ig.domHandler.getOffsets(e), n = e.left, m = e.top, ig.sizeHandler.enableStretchToFitOnDesktopFlag ? (e = Math.floor(n + this.pos.x * ig.sizeHandler.sizeRatio.x) + "px", m = Math.floor(m + this.pos.y * ig.sizeHandler.sizeRatio.y) + "px", n = Math.floor(this.size.x * ig.sizeHandler.sizeRatio.x) +
                "px", d = Math.floor(this.size.y * ig.sizeHandler.sizeRatio.y) + "px") : (e = Math.floor(n + this.pos.x * d) + "px", m = Math.floor(m + this.pos.y * d) + "px", n = Math.floor(this.size.x * d) + "px", d = Math.floor(this.size.y * d) + "px");
            ig.domHandler.css(f, {
                "float": "left",
                position: "absolute",
                left: e,
...
ig.module("game.entities.buttons.button-more-games").requires("game.entities.buttons.button", "plugins.clickable-div-layer").defines(function() {
    EntityButtonMoreGames = EntityButton.extend({
        type: ig.Entity.TYPE.A,
        gravityFactor: 0,
        animImage: new ig.Image("media/graphics/games/ui/moregames-btn.png"),
        size: {
            x: 64,
            y: 64
        },
        ...
        init: function(b, c, d) {
            this.parent(b, c, d);
            ig.global.wm || (this.currentAnim.alpha = 0, this.fadeIn(),
                this.div_layer_name = d.div_layer_name ? d.div_layer_name : "more-games", _SETTINGS.MoreGames.Enabled ? (_SETTINGS.MoreGames.Link && (this.link = _SETTINGS.MoreGames.Link), _SETTINGS.MoreGames.NewWindow && (this.newWindow = _SETTINGS.MoreGames.NewWindow), this.clickableLayer = new ClickableDivLayer(this)) : this.kill())
        },
        show: function() {
            var b = ig.domHandler.getElementById("#" + this.div_layer_name);
            ig.domHandler.show(b)
...
(function(b, c) {
    function d() {}
    var e = function() {
        var b, c, d, e, g = Function.call,
            t = Object.prototype,
            z = g.bind(t.hasOwnProperty),
            y = g.bind(t.propertyIsEnumerable),
            A = g.bind(t.toString),
            B = z(t, "__defineGetter__");
        B && (b = g.bind(t.__defineGetter__), c = g.bind(t.__defineSetter__), d = g.bind(t.__lookupGetter__), e = g.bind(t.__lookupSetter__));
        var I = function(b) {
        ...
        Object.getPrototypeOf || (Object.getPrototypeOf = function(b) {
            ...
            return c || null === c ? c : "[object Function]" ===
                A(b.constructor) ? b.constructor.prototype : b instanceof Object ? t : null
        });
        g = function(b) {
            try {
        ...
        if (Object.defineProperty) {
            var D = g({});
            if (!("undefined" == typeof document || g(document.createElement("div"))) || !D) var x = Object.getOwnPropertyDescriptor
        }
        if (!Object.getOwnPropertyDescriptor || x) Object.getOwnPropertyDescriptor = function(b, c) {
            if (I(b)) throw new TypeError("Object.getOwnPropertyDescriptor called on a non-object: " +
                b);
            if (x) try {
                return x.call(Object, b, c)
            } catch (f) {}
            var g;
            if (!z(b, c)) return g;
            if (g = {
                ...
                var s = d(b, c),
                    u = e(b, c);
                if (E && (b.__proto__ = j), s || u) return s && (g.get = s), u && (g.set = u), g
            }
        ...
        if (Object.getOwnPropertyNames || (Object.getOwnPropertyNames = function(b) {
            ...
            G = "undefined" == typeof document ? function() {
                ...
                delete g.valueOf;
                var s = function() {};
                return s.prototype = g, G = function() {
                    return new s
                }, new s
            };
        ...
        if (!Object.defineProperty || L) Object.defineProperty = function(g, x, E) {
            ...
            if ("value" in E)
                ...
                var y = "get" in E,
                    A = "set" in E;
                if (!B && (y || A)) throw new TypeError("getters & setters can not be defined on this javascript engine");
                y && b(g, x, E.get);
                A && c(g, x, E.set)
            }
            return g
    ...
    "function" == typeof define && define.amd ? define(e) : "object" ==
        typeof exports ? module.exports = e() : this.returnExports = e();
    !0;
...
(function() {
    ...
    function za() {
        za.b2ContactRegister.apply(this,
            arguments)
    }
    ...
    function sb() {
        sb.b2PolygonContact.apply(this,
            arguments)
    }
    ...
    function Ya() {
        ...
        this.constructor ===
            Ya && this.b2FrictionJointDef.apply(this, arguments)
    }
    ...
    function jb() {
        ...
        this.constructor ===
            jb && this.b2JointDef.apply(this, arguments)
    }
...
(function() {
    ...
    g.prototype.RayCast = function(b, c) {
        ...
        } else if (m = 1 / f, u = (this.lowerBound.x - e) * m, m *= this.upperBound.x - e, C = -1, u > m && (C = u, u = m, m = C, C = 1), u > d && (j.x = C, j.y = 0, d = u), l = Math.min(l, m), d > l) return !1;
        if (s < Number.MIN_VALUE) {
            if (g < this.lowerBound.y || this.upperBound.y < g) return !1
        } else if (m = 1 / q, u = (this.lowerBound.y - g) * m, m *= this.upperBound.y - g, C = -1, u > m && (C = u, u = m, m = C, C = 1), u > d && (j.y = C, j.x = 0, d = u), l = Math.min(l, m), d > l) return !1;
        b.fraction = d;
        return !0
    };
    ...
    y.EdgeSeparation = function(b, c, d, l, e) {
        ...
        for (var u = 0, C = Number.MAX_VALUE, K = 0; K < f; ++K) j = q[K], j = j.x * m + j.y * s, j < C && (C = j, u = K);
        j = g[d];
        s = c.R;
    ...
    y.FindMaxSeparation = function(b,
        ...
        for (var m = j * d.R.col2.x + m * d.R.col2.y, j = 0, u = -Number.MAX_VALUE, C = 0; C < g; ++C) s = f[C], s = s.x * q + s.y * m, s > u && (u = s, j = C);
        f = y.EdgeSeparation(c, d, j, l, e);
        s = parseInt(0 <= j - 1 ? j - 1 : g - 1);
        q = y.EdgeSeparation(c, d, s, l, e);
        var m = parseInt(j + 1 < g ? j + 1 : 0),
            u = y.EdgeSeparation(c, d, m, l, e),
            K = 0,
            x = 0;
        if (q > f && q > u) x = -1, C = s, K = q;
        else if (u > f) x = 1, C = m, K = u;
        else return b[0] = j, f;
        for (;;)
            if (j = -1 == x ? 0 <= C - 1 ? C - 1 : g - 1 : C + 1 < g ? C + 1 : 0, f = y.EdgeSeparation(c, d, j, l, e), f > K) C = j, K = f;
            else break;
        b[0] = C;
        return K
    };
    y.FindIncidentEdge = function(b, c, d, l, e, g) {
        void 0 === l && (l = 0);
        ...
        f = d;
        q = 0;
        for (var m = Number.MAX_VALUE, u = 0; u < s; ++u) d = e[u], d = f * d.x + j * d.y, d < m && (m = d, q = u);
        e = parseInt(q);
    ...
    y.CollidePolygons = function(b, c, d, l, g) {
        var f;
        b.m_pointCount = 0;
        var s = c.m_radius + l.m_radius;
        y.s_edgeAO[0] = 0;
        var q = y.FindMaxSeparation(y.s_edgeAO, c, d, l, g);
        f = y.s_edgeAO[0];
        if (!(q > s)) {
            var j;
            y.s_edgeBO[0] = 0;
            var m = y.FindMaxSeparation(y.s_edgeBO, l, g, c, d);
            j = y.s_edgeBO[0];
            if (!(m > s)) {
                var u = 0,
                    C = 0;
                m > 0.98 * q + 0.001 ? (q = l, l = c, c = g, u = j, b.m_type = J.e_faceB, C = 1) : (q = c, c = d, d = g,
                    u = f, b.m_type = J.e_faceA, C = 0);
                f = y.s_incidentEdge;
                y.FindIncidentEdge(f, q, c, u, l, d);
                j = parseInt(q.m_vertexCount);
                g = q.m_vertices;
                var q = g[u],
                    K;
                K = u + 1 < j ? g[parseInt(u + 1)] : g[0];
                u = y.s_localTangent;
                ...
                m = y.s_tangent;
                j = c.R;
                m.x = j.col1.x * u.x + j.col2.x * u.y;
                m.y = j.col1.y * u.x + j.col2.y * u.y;
                var x = y.s_tangent2;
                x.x = -m.x;
                x.y = -m.y;
                u = y.s_normal;
                ...
                var F = y.s_v11,
                    H = y.s_v12;
                F.x = c.position.x + (j.col1.x *
                    q.x + j.col2.x * q.y);
                F.y = c.position.y + (j.col1.y * q.x + j.col2.y * q.y);
                H.x = c.position.x + (j.col1.x * K.x + j.col2.x * K.y);
                H.y = c.position.y + (j.col1.y * K.x + j.col2.y * K.y);
                c = u.x * F.x + u.y * F.y;
                j = m.x * H.x + m.y * H.y + s;
                K = y.s_clipPoints1;
                q = y.s_clipPoints2;
                H = y.ClipSegmentToLine(K, f, x, -m.x * F.x - m.y * F.y + s);
                if (!(2 > H) && (H = y.ClipSegmentToLine(q, K, m, j), !(2 > H))) {
                    b.m_localPlaneNormal.SetV(g);
                    b.m_localPoint.SetV(l);
                    for (l = g = 0; l < e.b2_maxManifoldPoints; ++l) f = q[l], u.x * f.v.x + u.y * f.v.y - c <= s && (m = b.m_points[g], j = d.R, x = f.v.x - d.position.x, F = f.v.y -
                        d.position.y, m.m_localPoint.x = x * j.col1.x + F * j.col1.y, m.m_localPoint.y = x * j.col2.x + F * j.col2.y, m.m_id.Set(f.id), m.m_id.features.flip = C, ++g);
                    b.m_pointCount = g
                }
            }
        }
    ...
    y.CollideCircles = function(b, c, d, l, e) {
        ...
        q * q + e * e > g * g || (b.m_type = J.e_circles, b.m_localPoint.SetV(c.m_p),
            b.m_localPlaneNormal.SetZero(), b.m_pointCount = 1, b.m_points[0].m_localPoint.SetV(l.m_p), b.m_points[0].m_id.key = 0)
    };
    y.CollidePolygonAndCircle = function(b, c, d, l, e) {
        ...
        g = parseInt(m);
        f = parseInt(g + 1 < u ? g + 1 : 0);
        q = C[g];
        C = C[f];
        if (j < Number.MIN_VALUE) b.m_pointCount = 1, b.m_type = J.e_faceA, b.m_localPlaneNormal.SetV(c[m]), b.m_localPoint.x = 0.5 * (q.x + C.x), b.m_localPoint.y = 0.5 * (q.y + C.y);
        else if (j = (d - C.x) * (q.x - C.x) + (s - C.y) * (q.y - C.y), 0 >= (d - q.x) * (C.x - q.x) + (s - q.y) * (C.y - q.y)) {
    ...
    I.Distance = function(b, c, d) {
        ...
        for (var F = 0, H, R = 0; 20 >
            R;) {
            x = j.m_count;
            for (F = 0; F < x; F++) C[F] = u[F].indexA, K[F] = u[F].indexB;
            switch (j.m_count) {
                case 1:
                    break;
                case 2:
            ...
            H = u[j.m_count];
            H.indexA = l.GetSupport(f.MulTMV(q.R, F.GetNegative()));
        ...
        I.b2_gjkMaxIters = f.Max(I.b2_gjkMaxIters, R);
        j.GetWitnessPoints(b.pointA, b.pointB);
        b.distance = f.SubtractVV(b.pointA, b.pointB).Length();
        b.iterations = R;
        j.WriteCache(c);
        d.useRadii && (c = l.m_radius, g = g.m_radius, b.distance > c + g && b.distance > Number.MIN_VALUE ? (b.distance -= c + g, d = f.SubtractVV(b.pointB, b.pointA), d.Normalize(), b.pointA.x += c * d.x, b.pointA.y += c * d.y, b.pointB.x -= g * d.x,
            b.pointB.y -= g * d.y) : (H = new m, H.x = 0.5 * (b.pointA.x + b.pointB.x), H.y = 0.5 * (b.pointA.y + b.pointB.y), b.pointA.x = b.pointB.x = H.x, b.pointA.y = b.pointB.y = H.y, b.distance = 0))
    };
    Box2D.postDefs.push(function() {
    ...
    G.prototype.GetSupport = function(b) {
        for (var c = 0, d = this.m_vertices[0].x * b.x + this.m_vertices[0].y * b.y, l = 1; l < this.m_count; ++l) {
            var e = this.m_vertices[l].x * b.x + this.m_vertices[l].y *
                b.y;
            e > d && (c = l, d = e)
        }
        return c
    ...
    E.prototype.RayCast = function(b, c) {
        if (null != this.m_root) {
            ...
            j.lowerBound.y = Math.min(d.y, u);
            j.upperBound.x = Math.max(d.x, m);
            j.upperBound.y = Math.max(d.y, u);
            var C = new Vector,
                K = 0;
            for (C[K++] = this.m_root; 0 < K;)
                if (s = C[--K], !1 != s.aabb.TestOverlap(j) && (m = s.aabb.GetCenter(), u = s.aabb.GetExtents(), !(0 < Math.abs(e.x * (d.x - m.x) + e.y * (d.y - m.y)) - q.x * u.x - q.y * u.y)))
                    if (s.IsLeaf()) {
                        m = new P;
                        m.p1 = c.p1;
                        m.p2 = c.p2;
                        ...
                        s = b(m, s);
                        if (0 == s) break;
                        0 < s && (m = d.x + s * (l.x - d.x), u = d.y + s * (l.y - d.y),
                            j.lowerBound.x = Math.min(d.x, m), j.lowerBound.y = Math.min(d.y, u), j.upperBound.x = Math.max(d.x, m), j.upperBound.y = Math.max(d.y, u))
                    } else C[K++] = s.child1, C[K++] = s.child2
        }
    };
    ...
    U.prototype.TestSegment = function(b, c, d, l) {
        ...
        if (j > s) {
            var m = e.x - this.p1.x,
                u = e.y - this.p1.y,
                e = m * d + u * q;
            if (0 <= e && e <= l * j && (l = -g * u + f * m, -s * j <= l && l <= j * (1 + s))) return e /= j, l = Math.sqrt(d * d + q * q), b[0] = e, c.Set(d / l, q / l), !0
        }
        return !1
    };
            ...
            switch (this.m_type) {
                ...
                case s.e_faceB:
                    return g = f.MulMV(c.R,
                        this.m_axis), l = f.MulX(c, this.m_localPoint), d = f.MulTMV(b.R, g.GetNegative()), d = this.m_proxyA.GetSupportVertex(d), d = f.MulX(b, d), (d.x - l.x) * g.x + (d.y - l.y) * g.y;
                default:
    ...
    u.prototype.ReadCache = function(b, c, d, l, g) {
        ...
        for (var s = this.m_vertices, m = 0; m < this.m_count; m++) {
            ...
            u.indexA = b.indexA[m];
            u.indexB = b.indexB[m];
            q = c.GetVertex(u.indexA);
            j = l.GetVertex(u.indexB);
            u.wA = f.MulX(d, q);
            u.wB = f.MulX(g, j);
        ...
        0 == this.m_count &&
            (u = s[0], u.indexA = 0, u.indexB = 0, q = c.GetVertex(0), j = l.GetVertex(0), u.wA = f.MulX(d, q), u.wB = f.MulX(g, j), u.w = f.SubtractVV(u.wB, u.wA), this.m_count = 1)
    };
    ...
    u.prototype.Solve3 = function() {
        var b = this.m_v1.w,
            ...
            d = q * f.CrossVV(d, b),
            b = q * f.CrossVV(b, c);
        0 >= e && 0 >= j ? this.m_count = this.m_v1.a = 1 : 0 < g && 0 < e && 0 >= b ? (s = 1 / (g + e), this.m_v1.a = g * s, this.m_v2.a = e * s, this.m_count = 2) : 0 < s && 0 < j && 0 >= d ? (g = 1 / (s + j),
    ...
    H.TimeOfImpact = function(b) {
        ...
        for (H.s_distanceInput.useRadii = !1;;) {
            l.GetTransform(H.s_xfA, j);
            g.GetTransform(H.s_xfB, j);
            ...
            0 == s && (m = u > q ? f.Max(q - b, 0.75 * q) : f.Max(u - b, 0.02 * q));
            if (u - m < 0.5 * b) {
                if (0 == s) {
                    j = 1;
                    break
            ...
            var x = H.s_fcn.Evaluate(H.s_xfA,
                H.s_xfB);
            if (x >= m) {
                j = 1;
                break
            ...
            if (C < (1 + 100 * Number.MIN_VALUE) * j) break;
            j = C;
            s++;
            ++H.b2_toiIters;
            if (1E3 == s) break
        }
        H.b2_toiMaxIters = f.Max(H.b2_toiMaxIters, s);
        return j
    };
    Box2D.postDefs.push(function() {
        ...
        if (0 != b.m_pointCount) {
            ...
            switch (b.m_type) {
                case J.e_circles:
                    ...
                    q = l - c;
                    j = f * f + q * q;
                    j > Number.MIN_VALUE * Number.MIN_VALUE ? (j = Math.sqrt(j), this.m_normal.x = f / j, this.m_normal.y = q / j) : (this.m_normal.x = 1, this.m_normal.y = 0);
                ...
                case J.e_faceA:
                    ...
                    j = q.col1.x * f.x + q.col2.x *
                        f.y;
                    s = q.col1.y * f.x + q.col2.y * f.y;
                    q = c.R;
                    f = b.m_localPoint;
                    m = c.position.x + q.col1.x * f.x + q.col2.x * f.y;
                    u = c.position.y + q.col1.y * f.x + q.col2.y * f.y;
                    this.m_normal.x = j;
                    this.m_normal.y = s;
                    for (g = 0; g < b.m_pointCount; g++) q = l.R, f = b.m_points[g].m_localPoint, C = l.position.x + q.col1.x * f.x + q.col2.x * f.y, f = l.position.y + q.col1.y * f.x + q.col2.y * f.y, this.m_points[g].x = C + 0.5 * (d - (C - m) * j - (f - u) * s - e) * j, this.m_points[g].y = f + 0.5 * (d - (C - m) * j - (f - u) * s - e) * s;
                    break;
                case J.e_faceB:
                    q = l.R;
                    f = b.m_localPlaneNormal;
                    j = q.col1.x * f.x + q.col2.x * f.y;
                    s = q.col1.y *
                        f.x + q.col2.y * f.y;
                    q = l.R;
                    f = b.m_localPoint;
                    m = l.position.x + q.col1.x * f.x + q.col2.x * f.y;
                    u = l.position.y + q.col1.y * f.x + q.col2.y * f.y;
                    this.m_normal.x = -j;
                    this.m_normal.y = -s;
                    for (g = 0; g < b.m_pointCount; g++) q = c.R, f = b.m_points[g].m_localPoint, C = c.position.x + q.col1.x * f.x + q.col2.x * f.y, f = c.position.y + q.col1.y * f.x + q.col2.y * f.y, this.m_points[g].x = C + 0.5 * (e - (C - m) * j - (f - u) * s - d) * j, this.m_points[g].y = f + 0.5 * (e - (C - m) * j - (f - u) * s - d) * s
            }
        }
    };
...
(function() {
    ...
    c.prototype.RayCast = function(b, c, d) {
        ...
        return 0 <= j && j <= c.maxFraction *
            m ? (j /= m, b.fraction = j, b.normal.x = g + j * e, b.normal.y = d + j * f, b.normal.Normalize(), !0) : !1
    };
    ...
    e.prototype.RayCast = function(b, c, d) {
        ...
        if (t > e) {
            var j = c.p1.x - j,
                y = c.p1.y - m,
                m = j * n + y * d;
            if (0 <= m && m <= c.maxFraction * t && (c = -g * y + f * j, -e * t <= c && c <= t * (1 + e))) return b.fraction = m / t, c = Math.sqrt(n * n + d * d), b.normal.x = n / c, b.normal.y = d / c, !0
        }
        return !1
    };
    ...
    j.prototype.TestPoint = function(b, c) {
        var d;
        d = b.R;
        for (var e = c.x - b.position.x, g = c.y - b.position.y, f = e * d.col1.x + g * d.col1.y, j = e * d.col2.x + g * d.col2.y, m = 0; m < this.m_vertexCount; ++m)
            if (d = this.m_vertices[m], e = f - d.x, g = j - d.y, d = this.m_normals[m], 0 < d.x * e + d.y * g) return !1;
        return !0
    };
    j.prototype.RayCast = function(b, c, d) {
        ...
        return 0 <=
            A ? (b.fraction = e, m = d.R, n = this.m_normals[A], b.normal.x = m.col1.x * n.x + m.col2.x * n.y, b.normal.y = m.col1.y * n.x + m.col2.y * n.y, !0) : !1
    };
    j.prototype.ComputeAABB = function(b, c) {
        for (var d = c.R, e = this.m_vertices[0], g = c.position.x + (d.col1.x * e.x + d.col2.x * e.y), f = c.position.y + (d.col1.y * e.x + d.col2.y * e.y), j = g, m = f, n = 1; n < this.m_vertexCount; ++n) var e = this.m_vertices[n],
    ...
    j.prototype.ComputeMass = function(b, c) {
        ...
        if (2 == this.m_vertexCount) b.center.x = 0.5 * (this.m_vertices[0].x + this.m_vertices[1].x), b.center.y = 0.5 * (this.m_vertices[0].y + this.m_vertices[1].y), b.mass = 0, b.I = 0;
            ...
            for (var d = 0, e = 0, g = 0, f = 0, j = 1 / 3, m = 0; m < this.m_vertexCount; ++m) var n = this.m_vertices[m],
                t = m + 1 < this.m_vertexCount ? this.m_vertices[parseInt(m + 1)] : this.m_vertices[0],
                y = n.x - 0,
                A = n.y - 0,
                s = t.x - 0,
                u = t.y -
                ...
                e = e + C * j * (0 + n.y + t.y),
                n = y,
                f = f + F * (j * (0.25 * (n * n + s * n + s * s) + (0 * n + 0 * s)) + 0 + (j * (0.25 * (A * A + u * A + u * u) + (0 * A + 0 * u)) + 0));
            b.mass = c * g;
    ...
    j.prototype.ComputeSubmergedArea = function(b, c, d, e) {
        ...
        m = (0 - n[y]) / (n[b] - n[y]);
        n = (0 - n[c]) / (n[j] - n[c]);
        y = new z(this.m_vertices[y].x * (1 - m) + this.m_vertices[b].x * m, this.m_vertices[y].y * (1 - m) + this.m_vertices[b].y * m);
        c = new z(this.m_vertices[c].x * (1 - n) + this.m_vertices[j].x * n, this.m_vertices[c].y * (1 - n) + this.m_vertices[j].y * n);
        n = 0;
        m =
            new z;
        for (t = this.m_vertices[b]; b != j;) b = (b + 1) % this.m_vertexCount, A = b == j ? c : this.m_vertices[b], B = 0.5 * ((t.x - y.x) * (A.y - y.y) - (t.y - y.y) * (A.x - y.x)), n += B, m.x += B * (y.x + t.x + A.x) / 3, m.y += B * (y.y + t.y + A.y) / 3, t = A;
        m.Multiply(1 / n);
        e.SetV(g.MulX(d, m));
        return n
    };
    ...
    j.ComputeCentroid = function(b, c) {
        void 0 === c && (c = 0);
        for (var d = new z, e = 0, g = 1 / 3, f = 0; f < c; ++f) {
            var j = b[f],
    ...
    j.ComputeOBB = function(b, c, d) {
        ...
        c = Number.MAX_VALUE;
        for (e = 1; e <= d; ++e) {
            for (var f = g[parseInt(e - 1)], j = g[e].x - f.x, m = g[e].y - f.y, n = Math.sqrt(j * j + m * m), j = j / n, m = m / n, t = -m, y = j, A = n = Number.MAX_VALUE, s = -Number.MAX_VALUE, u = -Number.MAX_VALUE, F = 0; F < d; ++F) {
                var C = g[F].x - f.x,
                    H = g[F].y - f.y,
                    Z = j * C + m * H,
                    C = t * C + y * H;
            ...
            F = (s - n) * (u - A);
            F < 0.95 * c && (c = F, b.R.col1.x = j, b.R.col1.y = m, b.R.col2.x = t, b.R.col2.y = y, j = 0.5 * (n + s), m = 0.5 * (A + u), t = b.R, b.center.x = f.x + (t.col1.x *
                j + t.col2.x * m), b.center.y = f.y + (t.col1.y * j + t.col2.y * m), b.extents.x = 0.5 * (s - n), b.extents.y = 0.5 * (u - A))
        }
    };
    Box2D.postDefs.push(function() {
...
(function() {
    ...
    c.prototype.Solve33 = function(b, c, d, e) {
        ...
        var f = this.col1.x,
            ...
            E = this.col3.y,
            L = this.col3.z,
            M = f * (D * L - x * E) + j * (x * G - I * L) + n * (I * E - D * G);
        0 != M && (M = 1 / M);
        b.x = M * (c * (D * L - x * E) + d * (x * G - I * L) + e * (I * E - D * G));
        b.y = M * (f * (d * L - e * E) + j * (e * G - c * L) + n * (c * E - d * G));
        b.z = M * (f * (D * e - x * d) + j * (x * c - I * e) + n * (I * d - D * c));
        return b
    };
    d.b2Math = function() {};
...
(function() {
    ...
    x.prototype.connectEdges = function(c, d, e) {
        void 0 === e && (e = 0);
    ...
    x.prototype.CreateFixture = function(b) {
        if (!0 == this.m_world.IsLocked()) return null;
        var c = new P;
        c.Create(this, this.m_xf, b);
        this.m_flags & x.e_activeFlag && c.CreateProxy(this.m_world.m_contactManager.m_broadPhase, this.m_xf);
    ...
    x.prototype.CreateFixture2 = function(b, c) {
        void 0 === c && (c = 0);
        var d = new ba;
        d.shape = b;
        d.density = c;
    ...
    x.prototype.DestroyFixture = function(b) {
        if (!0 != this.m_world.IsLocked()) {
            ...
            this.m_flags &
                x.e_activeFlag && b.DestroyProxy(this.m_world.m_contactManager.m_broadPhase);
            b.Destroy();
            b.m_body = null;
            b.m_next = null;
            --this.m_fixtureCount;
    ...
    x.prototype.SetPositionAndAngle = function(b, c) {
        void 0 === c && (c = 0);
        var d;
        if (!0 != this.m_world.IsLocked()) {
            this.m_xf.R.Set(c);
    ...
    x.prototype.SetTransform = function(b) {
    ...
    x.prototype.SetPosition = function(b) {
    ...
    x.prototype.SetAngle = function(b) {
        void 0 === b && (b = 0);
    ...
    x.prototype.SetLinearVelocity = function(b) {
        this.m_type != x.b2_staticBody && this.m_linearVelocity.SetV(b)
    };
    x.prototype.GetLinearVelocity = function() {
        return this.m_linearVelocity
    };
    x.prototype.SetAngularVelocity =
        function(b) {
            void 0 === b && (b = 0);
            this.m_type != x.b2_staticBody && (this.m_angularVelocity = b)
        };
    ...
    x.prototype.GetDefinition = function() {
        var b = new G;
        b.type = this.GetType();
        b.allowSleep = (this.m_flags & x.e_allowSleepFlag) == x.e_allowSleepFlag;
        b.angle = this.GetAngle();
        b.angularDamping = this.m_angularDamping;
        b.angularVelocity = this.m_angularVelocity;
        b.fixedRotation = (this.m_flags & x.e_fixedRotationFlag) == x.e_fixedRotationFlag;
        b.bullet = (this.m_flags &
            x.e_bulletFlag) == x.e_bulletFlag;
        b.awake = (this.m_flags & x.e_awakeFlag) == x.e_awakeFlag;
    ...
    x.prototype.ApplyForce = function(b, c) {
        this.m_type == x.b2_dynamicBody && (!1 == this.IsAwake() && this.SetAwake(!0), this.m_force.x += b.x, this.m_force.y += b.y, this.m_torque += (c.x - this.m_sweep.c.x) * b.y - (c.y - this.m_sweep.c.y) * b.x)
    };
    x.prototype.ApplyTorque = function(b) {
        void 0 ===
            b && (b = 0);
        this.m_type == x.b2_dynamicBody && (!1 == this.IsAwake() && this.SetAwake(!0), this.m_torque += b)
    };
    x.prototype.ApplyImpulse = function(b, c) {
        this.m_type == x.b2_dynamicBody && (!1 == this.IsAwake() && this.SetAwake(!0), this.m_linearVelocity.x += this.m_invMass * b.x, this.m_linearVelocity.y += this.m_invMass * b.y, this.m_angularVelocity += this.m_invI * ((c.x - this.m_sweep.c.x) * b.y - (c.y - this.m_sweep.c.y) * b.x))
    };
    x.prototype.Split = function(c) {
        for (var d = this.GetLinearVelocity().Copy(), e = this.GetAngularVelocity(), f = this.GetWorldCenter(),
            ...
            if (c(s)) {
                var u = s.m_next;
                j ? j.m_next = u : this.m_fixtureList = u;
                this.m_fixtureCount--;
    ...
    x.prototype.GetMassData = function(b) {
        b.mass = this.m_mass;
        b.I = this.m_I;
        b.center.SetV(this.m_sweep.localCenter)
    };
    x.prototype.SetMassData = function(c) {
        j.b2Assert(!1 == this.m_world.IsLocked());
        if (!0 != this.m_world.IsLocked() && this.m_type == x.b2_dynamicBody) {
            this.m_invI = this.m_I = this.m_invMass = 0;
            this.m_mass = c.mass;
            0 >= this.m_mass && (this.m_mass = 1);
            this.m_invMass = 1 / this.m_mass;
            0 < c.I && 0 == (this.m_flags & x.e_fixedRotationFlag) && (this.m_I = c.I - this.m_mass * (c.center.x *
    ...
    x.prototype.ResetMassData = function() {
        ...
        if (!(this.m_type ==
                x.b2_staticBody || this.m_type == x.b2_kinematicBody)) {
            ...
            0 < this.m_I && 0 == (this.m_flags & x.e_fixedRotationFlag) ? (this.m_I -= this.m_mass * (c.x * c.x + c.y * c.y), this.m_I *= this.m_inertiaScale, j.b2Assert(0 < this.m_I), this.m_invI = 1 /
    ...
    x.prototype.GetWorldPoint = function(b) {
        var c = this.m_xf.R;
    ...
    x.prototype.GetWorldVector = function(c) {
        return b.MulMV(this.m_xf.R, c)
    };
    x.prototype.GetLocalPoint = function(c) {
        return b.MulXT(this.m_xf, c)
    };
    x.prototype.GetLocalVector = function(c) {
        return b.MulTMV(this.m_xf.R, c)
    };
    x.prototype.GetLinearVelocityFromWorldPoint = function(b) {
    ...
    x.prototype.GetLinearVelocityFromLocalPoint = function(b) {
        var c = this.m_xf.R;
        b = new e(c.col1.x * b.x + c.col2.x * b.y, c.col1.y * b.x + c.col2.y * b.y);
        b.x += this.m_xf.position.x;
        b.y += this.m_xf.position.y;
    ...
    x.prototype.SetLinearDamping = function(b) {
        void 0 === b && (b = 0);
    ...
    x.prototype.SetAngularDamping =
        function(b) {
            void 0 === b && (b = 0);
            this.m_angularDamping = b
        };
    x.prototype.SetType = function(b) {
        void 0 === b && (b = 0);
        if (this.m_type != b) {
            this.m_type = b;
            this.ResetMassData();
            this.m_type == x.b2_staticBody && (this.m_linearVelocity.SetZero(), this.m_angularVelocity = 0);
            this.SetAwake(!0);
    ...
    x.prototype.SetBullet = function(b) {
        this.m_flags = b ? this.m_flags | x.e_bulletFlag : this.m_flags &
            ~x.e_bulletFlag
    };
    x.prototype.IsBullet = function() {
        return (this.m_flags & x.e_bulletFlag) == x.e_bulletFlag
    };
    x.prototype.SetSleepingAllowed = function(b) {
        b ? this.m_flags |= x.e_allowSleepFlag : (this.m_flags &= ~x.e_allowSleepFlag, this.SetAwake(!0))
    };
    x.prototype.SetAwake = function(b) {
        b ? (this.m_flags |= x.e_awakeFlag, this.m_sleepTime = 0) : (this.m_flags &= ~x.e_awakeFlag, this.m_sleepTime = 0, this.m_linearVelocity.SetZero(), this.m_angularVelocity = 0, this.m_force.SetZero(), this.m_torque = 0)
    };
    x.prototype.IsAwake = function() {
        return (this.m_flags &
            x.e_awakeFlag) == x.e_awakeFlag
    };
    x.prototype.SetFixedRotation = function(b) {
        this.m_flags = b ? this.m_flags | x.e_fixedRotationFlag : this.m_flags & ~x.e_fixedRotationFlag;
        this.ResetMassData()
    };
    x.prototype.IsFixedRotation = function() {
        return (this.m_flags & x.e_fixedRotationFlag) == x.e_fixedRotationFlag
    };
    x.prototype.SetActive = function(b) {
        if (b != this.IsActive()) {
            var c;
            if (b) {
    ...
    x.prototype.b2Body = function(b, c) {
        this.m_flags = 0;
        b.bullet && (this.m_flags |= x.e_bulletFlag);
        b.fixedRotation && (this.m_flags |=
            x.e_fixedRotationFlag);
        b.allowSleep && (this.m_flags |= x.e_allowSleepFlag);
        b.awake && (this.m_flags |= x.e_awakeFlag);
        b.active && (this.m_flags |= x.e_activeFlag);
        this.m_world = c;
        ...
        this.m_type = b.type;
        this.m_invMass = this.m_type == x.b2_dynamicBody ? this.m_mass = 1 : this.m_mass = 0;
    ...
    x.prototype.ShouldCollide = function(b) {
        if (this.m_type != x.b2_dynamicBody && b.m_type != x.b2_dynamicBody) return !1;
        for (var c = this.m_jointList; c; c = c.next)
            if (c.other == b && !1 == c.joint.m_collideConnected) return !1;
        return !0
    };
    x.prototype.Advance = function(b) {
        void 0 === b && (b = 0);
            ...
            for (var j = g.GetContactList(); j;) {
                if (j.other == f) {
                    var s = j.contact.GetFixtureA(),
                        u = j.contact.GetFixtureB();
                    if (s == d && u == e || s == e && u == d) return
                }
                j = j.next
    ...
    U.prototype.Solve = function(c, d, e) {
        for (var f = 0, g = 0, s, f = 0; f < this.m_bodyCount; ++f) g = this.m_bodies[f], g.GetType() == x.b2_dynamicBody && (g.m_linearVelocity.x += c.dt * (d.x +
        ...
        for (f = 0; f < this.m_bodyCount; ++f)
            if (g = this.m_bodies[f], g.GetType() != x.b2_staticBody) {
                var u = c.dt * g.m_linearVelocity.x,
                    C = c.dt * g.m_linearVelocity.y;
                u * u + C * C > j.b2_maxTranslationSquared && (g.m_linearVelocity.Normalize(), g.m_linearVelocity.x *= j.b2_maxTranslation * c.inv_dt, g.m_linearVelocity.y *=
                    j.b2_maxTranslation * c.inv_dt);
                u = c.dt * g.m_angularVelocity;
                u * u > j.b2_maxRotationSquared && (g.m_angularVelocity = 0 > g.m_angularVelocity ? -j.b2_maxRotation * c.inv_dt : j.b2_maxRotation * c.inv_dt);
        ...
        for (f = 0; f < c.positionIterations; ++f) {
            ...
            for (g = 0; g < this.m_jointCount; ++g) s =
                this.m_joints[g], s = s.SolvePositionConstraints(j.b2_contactBaumgarte), C = C && s;
            if (u && C) break
        }
        ...
        if (e) {
            ...
            for (f = 0; f < this.m_bodyCount; ++f) g = this.m_bodies[f], g.GetType() != x.b2_staticBody && (0 == (g.m_flags & x.e_allowSleepFlag) && (e = g.m_sleepTime = 0), 0 == (g.m_flags & x.e_allowSleepFlag) || g.m_angularVelocity * g.m_angularVelocity > u || b.Dot(g.m_linearVelocity, g.m_linearVelocity) >
    ...
    U.prototype.SolveTOI = function(b) {
        ...
        for (c =
            ...
            if (d = this.m_bodies[c], d.GetType() != x.b2_staticBody) {
        ...
        if (null != this.m_debugDraw) {
            ...
            if (b & J.e_shapeBit)
                for (c = this.m_bodyList; c; c =
                    c.m_next) {
                    j = c.m_xf;
                    for (d = c.GetFixtureList(); d; d = d.m_next) g = d.GetShape(), !1 == c.IsActive() ? s.Set(0.5, 0.5, 0.3) : c.GetType() == x.b2_staticBody ? s.Set(0.5, 0.9, 0.5) : c.GetType() == x.b2_kinematicBody ? s.Set(0.5, 0.5, 0.9) : !1 == c.IsAwake() ? s.Set(0.6, 0.6, 0.6) : s.Set(0.9, 0.7, 0.7), this.DrawShape(g, j, s)
                }
            if (b & J.e_jointBit)
    ...
    u.prototype.Solve = function(b) {
        ...
        for (c = this.m_bodyList; c; c = c.m_next) c.m_flags &= ~x.e_islandFlag;
        ...
        for (var e = this.s_stack, f = this.m_bodyList; f; f = f.m_next)
            if (!(f.m_flags & x.e_islandFlag) && !(!1 == f.IsAwake() || !1 == f.IsActive()) && f.GetType() != x.b2_staticBody) {
                d.Clear();
                var g = 0;
                e[g++] = f;
                for (f.m_flags |= x.e_islandFlag; 0 < g;)
                    if (c = e[--g], d.AddBody(c), !1 == c.IsAwake() && c.SetAwake(!0), c.GetType() != x.b2_staticBody) {
                        for (var j, s = c.m_contactList; s; s = s.next)
                            if (!(s.contact.m_flags & F.e_islandFlag) && !(!0 ==
                                    s.contact.IsSensor() || !1 == s.contact.IsEnabled() || !1 == s.contact.IsTouching())) d.AddContact(s.contact), s.contact.m_flags |= F.e_islandFlag, j = s.other, j.m_flags & x.e_islandFlag || (e[g++] = j, j.m_flags |= x.e_islandFlag);
                        for (c = c.m_jointList; c; c = c.next) !0 != c.joint.m_islandFlag && (j = c.other, !1 != j.IsActive() && (d.AddJoint(c.joint), c.joint.m_islandFlag = !0, j.m_flags & x.e_islandFlag || (e[g++] = j, j.m_flags |= x.e_islandFlag)))
                    }
        ...
        for (c = this.m_bodyList; c; c = c.m_next) !1 == c.IsAwake() || !1 == c.IsActive() || c.GetType() != x.b2_staticBody && c.SynchronizeFixtures();
    ...
    u.prototype.SolveTOI = function(b) {
        ...
        var g = u.s_queue;
        for (c = this.m_bodyList; c; c =
            c.m_next) c.m_flags &= ~x.e_islandFlag, c.m_sweep.t0 = 0;
        ...
        for (;;) {
            ...
            for (e = this.m_contactList; e; e = e.m_next)
                if (!(!0 == e.IsSensor() || !1 == e.IsEnabled() || !1 == e.IsContinuous())) {
                    if (e.m_flags & F.e_toiFlag) c = e.m_toi;
                        ...
                        c = c.m_body;
                        d = d.m_body;
                        if ((c.GetType() != x.b2_dynamicBody || !1 == c.IsAwake()) && (d.GetType() != x.b2_dynamicBody || !1 == d.IsAwake())) continue;
                        var m = c.m_sweep.t0;
            ...
            if (!0 == s.IsSensor() || !1 == s.IsEnabled()) c.m_sweep.Set(u.s_backupA), d.m_sweep.Set(u.s_backupB), c.SynchronizeTransform(), d.SynchronizeTransform();
                ...
                s = e = 0;
                g[e + s++] = c;
                for (c.m_flags |= x.e_islandFlag; 0 < s;)
                    if (c = g[e++], --s, f.AddBody(c), !1 == c.IsAwake() && c.SetAwake(!0), c.GetType() == x.b2_dynamicBody) {
                        for (d = c.m_contactList; d && f.m_contactCount != f.m_contactCapacity; d = d.next)
                            if (!(d.contact.m_flags & F.e_islandFlag) && !(!0 ==
                                    d.contact.IsSensor() || !1 == d.contact.IsEnabled() || !1 == d.contact.IsTouching())) f.AddContact(d.contact), d.contact.m_flags |= F.e_islandFlag, m = d.other, m.m_flags & x.e_islandFlag || (m.GetType() != x.b2_staticBody && (m.Advance(C), m.SetAwake(!0)), g[e + s] = m, ++s, m.m_flags |= x.e_islandFlag);
                        for (c = c.m_jointList; c; c = c.next) f.m_jointCount != f.m_jointCapacity && !0 != c.joint.m_islandFlag && (m = c.other, !1 != m.IsActive() && (f.AddJoint(c.joint), c.joint.m_islandFlag = !0, m.m_flags & x.e_islandFlag || (m.GetType() != x.b2_staticBody && (m.Advance(C),
                ...
                for (C = C = 0; C < f.m_bodyCount; ++C)
                    if (c = f.m_bodies[C], c.m_flags &= ~x.e_islandFlag, !1 != c.IsAwake() && c.GetType() == x.b2_dynamicBody) {
...
(function() {
        ...
        if (this.m_flags & j.e_sensorFlag) s && (d = this.m_fixtureA.GetShape(),
            ...
            if (s) {
                ...
                for (s = 0; s < this.m_manifold.m_pointCount; ++s) {
                    var u = this.m_manifold.m_points[s];
                    u.m_normalImpulse = 0;
                    u.m_tangentImpulse = 0;
                    for (var m = u.m_id, F = 0; F < this.m_oldManifold.m_pointCount; ++F) {
                        var n =
    ...
    A.prototype.Initialize = function(b, c, d, e) {
        ...
        for (b = 0; b <
            ...
            var g = f.m_fixtureB,
                ...
                m = g.m_body,
                F = f.GetManifold(),
                t = Q.b2MixFriction(e.GetFriction(), g.GetFriction()),
                x = Q.b2MixRestitution(e.GetRestitution(), g.GetRestitution()),
            ...
            A.s_worldManifold.Initialize(F, u.m_xf, j, m.m_xf, s);
            ...
            for (j = 0; j < e.pointCount; ++j) {
                t = F.m_points[j];
                s = e.points[j];
                s.normalImpulse = t.m_normalImpulse;
                s.tangentImpulse = t.m_tangentImpulse;
                s.localPoint.SetV(t.m_localPoint);
                var t = s.rA.x = A.s_worldManifold.m_points[j].x -
                    u.m_sweep.c.x,
                    x = s.rA.y = A.s_worldManifold.m_points[j].y - u.m_sweep.c.y,
                    G = s.rB.x = A.s_worldManifold.m_points[j].x - m.m_sweep.c.x,
                    L = s.rB.y = A.s_worldManifold.m_points[j].y - m.m_sweep.c.y,
                    J = t * f - x * g,
                    M = G * f - L * g,
                    J = J * J,
                    M = M * M;
                s.normalMass = 1 / (u.m_invMass + m.m_invMass + u.m_invI * J + m.m_invI * M);
                ...
                J *= J;
                M *= M;
                s.tangentMass = 1 / (u.m_invMass + m.m_invMass + u.m_invI * J + m.m_invI * M);
                s.velocityBias =
                    0;
                t = e.normal.x * (z + -I * L - y - -E * x) + e.normal.y * (D + I * G - B - E * t);
                t < -Q.b2_velocityThreshold && (s.velocityBias += -e.restitution * t)
            }
            2 == e.pointCount && (D = e.points[0], z = e.points[1], F = u.m_invMass, u = u.m_invI, y = m.m_invMass, m = m.m_invI, B = D.rA.x * f - D.rA.y * g, D = D.rB.x * f - D.rB.y * g, E = z.rA.x * f - z.rA.y * g, z = z.rB.x * f - z.rB.y * g, g = F + y + u * B * B + m * D * D, f = F + y + u * E * E + m * z * z, m = F + y + u * B * E + m * D * z, g * g < 100 * (g * f - m * m) ? (e.K.col1.Set(g, m), e.K.col2.Set(m, f), e.K.GetInverse(e.normalMass)) : e.pointCount = 1)
        }
    };
            ...
            if (b.warmStarting) {
                ...
                for (x = 0; x < y; ++x) {
                    ...
                    var B = A.normalImpulse * m + A.tangentImpulse * n,
                        z = A.normalImpulse * F + A.tangentImpulse * t;
                    e.m_angularVelocity -= j * (A.rA.x * z - A.rA.y * B);
                    e.m_linearVelocity.x -= g * B;
                    e.m_linearVelocity.y -= g * z;
                    f.m_angularVelocity += u * (A.rB.x *
                        z - A.rB.y * B);
                    f.m_linearVelocity.x += s * B;
                    f.m_linearVelocity.y += s * z
                }
            } else {
                y = d.pointCount;
                for (x = 0; x < y; ++x) e = d.points[x], e.normalImpulse = 0, e.tangentImpulse = 0
            }
        }
    };
    A.prototype.SolveVelocityConstraints = function() {
        for (var b = 0, c, d = 0, e = 0, f = 0, g = 0, j = 0, s = 0, u = 0, m, F = 0; F < this.m_constraintCount; ++F) {
            ...
            m = -s;
            j = f.friction;
            for (b = 0; b < f.pointCount; b++) c = f.points[b], d = B.x - y * c.rB.y - A.x + x * c.rA.y, e = B.y + y * c.rB.x - A.y - x * c.rA.x, d = d * G + e * m, d = c.tangentMass * -d, e = j * c.normalImpulse, e = fa.Clamp(c.tangentImpulse + d, -e, e), d = e - c.tangentImpulse, g = d * G, d *= m, A.x -= z * g, A.y -= z * d, x -= D * (c.rA.x * d - c.rA.y * g), B.x += E * g, B.y += E * d, y += I * (c.rB.x * d - c.rB.y * g), c.tangentImpulse = e;
            parseInt(f.pointCount);
            if (1 == f.pointCount) c = f.points[0], d = B.x + -y * c.rB.y - A.x - -x * c.rA.y, e = B.y + y * c.rB.x - A.y - x * c.rA.x, f = d * s + e * u, d = -c.normalMass * (f - c.velocityBias), e = c.normalImpulse + d, e =
                0 < e ? e : 0, d = e - c.normalImpulse, g = d * s, d *= u, A.x -= z * g, A.y -= z * d, x -= D * (c.rA.x * d - c.rA.y * g), B.x += E * g, B.y += E * d, y += I * (c.rB.x * d - c.rB.y * g), c.normalImpulse = e;
            else {
                c = f.points[0];
                var b = f.points[1],
                    d = c.normalImpulse,
                    j = b.normalImpulse,
                    L = (B.x - y * c.rB.y - A.x + x * c.rA.y) * s + (B.y + y * c.rB.x - A.y - x * c.rA.x) * u,
                    J = (B.x - y * b.rB.y - A.x + x * b.rA.y) * s + (B.y + y * b.rB.x - A.y - x * b.rA.x) * u,
                    e = L - c.velocityBias,
                    g = J - b.velocityBias;
                m = f.K;
                ...
                for (g -= m.col1.y * d + m.col2.y * j;;) {
                    ...
                    if (0 <= G && 0 <= m) {
                        ...
                        A.x -= z * (f + s);
                        A.y -= z * (d + u);
                        x -= D * (c.rA.x * d - c.rA.y * f + b.rA.x * u - b.rA.y * s);
                        B.x += E * (f + s);
                        B.y += E * (d + u);
                        y += I * (c.rB.x * d - c.rB.y * f + b.rB.x * u - b.rB.y * s);
                        c.normalImpulse = G;
                        b.normalImpulse = m;
                        break
                    }
    ...
    x.Destroy = function() {};
    x.prototype.Reset = function(b, c) {
        this.__super.Reset.call(this, b, c);
        Q.b2Assert(b.GetType() == e.e_polygonShape);
    ...
    x.prototype.b2CollidePolyAndEdge = function() {};
    ...
    t.prototype.Step = function() {
        ...
        if (this.invSqr)
            for (b = this.m_bodyList; b; b = b.nextBody) {
                ...
                e = c.GetWorldCenter();
                f = c.GetMass();
                for (g = this.m_bodyList; g != b; g = g.nextBody) j = g.body, m = j.GetWorldCenter(), n = m.x - e.x, t = m.y - e.y, z = n * n + t * t, z < Number.MIN_VALUE || (n = new d(n, t), n.Multiply(this.G / z / Math.sqrt(z) * f * j.GetMass()),
                    c.IsAwake() && c.ApplyForce(n, e), n.Multiply(-1), j.IsAwake() && j.ApplyForce(n, m))
            } else
                for (b = this.m_bodyList; b; b = b.nextBody) {
                    c = b.body;
                    e = c.GetWorldCenter();
                    f = c.GetMass();
                    for (g = this.m_bodyList; g != b; g = g.nextBody) j = g.body, m = j.GetWorldCenter(), n = m.x - e.x, t = m.y - e.y, z = n * n + t * t, z < Number.MIN_VALUE || (n = new d(n, t), n.Multiply(this.G / z * f * j.GetMass()), c.IsAwake() && c.ApplyForce(n, e), n.Multiply(-1), j.IsAwake() && j.ApplyForce(n, m))
                }
    };
...
(function() {
    ...
    n.prototype.InitVelocityConstraints = function(c) {
        ...
        c.warmStarting ? (this.m_impulse *= c.dtRatio, c = this.m_impulse * this.m_u.x, d = this.m_impulse * this.m_u.y, f.m_linearVelocity.x -= f.m_invMass * c, f.m_linearVelocity.y -=
            f.m_invMass * d, f.m_angularVelocity -= f.m_invI * (j * d - m * c), g.m_linearVelocity.x += g.m_invMass * c, g.m_linearVelocity.y += g.m_invMass * d, g.m_angularVelocity += g.m_invI * (l * d - q * c)) : this.m_impulse = 0
    };
    ...
    g.prototype.InitVelocityConstraints = function(b) {
        ...
        b.warmStarting ? (this.m_linearImpulse.x *= b.dtRatio, this.m_linearImpulse.y *= b.dtRatio, this.m_angularImpulse *= b.dtRatio, b = this.m_linearImpulse, f.m_linearVelocity.x -= d * b.x, f.m_linearVelocity.y -= d * b.y, f.m_angularVelocity -= n * (j * b.y - m * b.x + this.m_angularImpulse), g.m_linearVelocity.x += e * b.x,
            g.m_linearVelocity.y += e * b.y, g.m_angularVelocity += r * (l * b.y - q * b.x + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(), this.m_angularImpulse = 0)
    };
    g.prototype.SolveVelocityConstraints = function(b) {
        ...
        n -= x * d;
        q += y * d;
        c = e.MulMV(this.m_linearMass, new f(-(l.x - q * D - m.x + n * B), -(l.y + q * A - m.y - n * z)));
    ...
    z.prototype.InitVelocityConstraints = function(b) {
        var c = this.m_ground1,
            ...
            r = 0;
        this.m_J.SetZero();
        this.m_revolute1 ? (this.m_J.angularA = -1, r += e.m_invI) : (c = c.m_xf.R, j = this.m_prismatic1.m_localXAxis1, g = c.col1.x *
            j.x + c.col2.x * j.y, j = c.col1.y * j.x + c.col2.y * j.y, c = e.m_xf.R, l = this.m_localAnchor1.x - e.m_sweep.localCenter.x, m = this.m_localAnchor1.y - e.m_sweep.localCenter.y, n = c.col1.x * l + c.col2.x * m, m = c.col1.y * l + c.col2.y * m, l = n * j - m * g, this.m_J.linearA.Set(-g, -j), this.m_J.angularA = -l, r += e.m_invMass + e.m_invI * l * l);
        this.m_revolute2 ? (this.m_J.angularB = -this.m_ratio, r += this.m_ratio * this.m_ratio * f.m_invI) : (c = d.m_xf.R, j = this.m_prismatic2.m_localXAxis1, g = c.col1.x * j.x + c.col2.x * j.y, j = c.col1.y * j.x + c.col2.y * j.y, c = f.m_xf.R, l = this.m_localAnchor2.x -
            f.m_sweep.localCenter.x, m = this.m_localAnchor2.y - f.m_sweep.localCenter.y, n = c.col1.x * l + c.col2.x * m, m = c.col1.y * l + c.col2.y * m, l = n * j - m * g, this.m_J.linearB.Set(-this.m_ratio * g, -this.m_ratio * j), this.m_J.angularB = -this.m_ratio * l, r += this.m_ratio * this.m_ratio * (f.m_invMass + f.m_invI * l * l));
    ...
    x.prototype.GetJointSpeed = function() {
        ...
        return d * -b * m.y + g * b * m.x + (m.x * (r.x + -c *
            l - n.x - -b * f) + m.y * (r.y + c * j - n.y - b * e))
    };
    ...
    x.prototype.SetMaxMotorForce = function(b) {
        void 0 === b && (b = 0);
        this.m_bodyA.SetAwake(!0);
        this.m_bodyB.SetAwake(!0);
    ...
    x.prototype.b2LineJoint = function(b) {
        this.__super.b2Joint.call(this, b);
        this.m_localAnchor1.SetV(b.localAnchorA);
        this.m_localAnchor2.SetV(b.localAnchorB);
    ...
    x.prototype.InitVelocityConstraints = function(c) {
        var d = this.m_bodyA,
            f = this.m_bodyB,
            g, j = 0;
        ...
        this.m_a1 =
            (g + n) * this.m_axis.y - (j + l) * this.m_axis.x;
        ...
        l = this.m_invIA;
        q = this.m_invIB;
        this.m_K.col1.x = m + n + l * this.m_s1 *
    ...
    x.prototype.SolveVelocityConstraints = function(b) {
        var c = this.m_bodyA,
            d = this.m_bodyB,
        ...
        this.m_enableMotor && this.m_limitState != B.e_equalLimits && (r = this.m_motorMass * (this.m_motorSpeed - (this.m_axis.x * (m.x - g.x) + this.m_axis.y * (m.y - g.y) + this.m_a2 * n - this.m_a1 * j)), l = this.m_motorImpulse, q = b.dt * this.m_maxMotorForce, this.m_motorImpulse = e.Clamp(this.m_motorImpulse + r, -q, q), r = this.m_motorImpulse - l, l = r * this.m_axis.x, q = r * this.m_axis.y, t = r * this.m_a1, r *= this.m_a2, g.x -= this.m_invMassA * l, g.y -= this.m_invMassA *
            q, j -= this.m_invIA * t, m.x += this.m_invMassB * l, m.y += this.m_invMassB * q, n += this.m_invIB * r);
    ...
    x.prototype.SolvePositionConstraints = function() {
        ...
        var B = this.m_localAnchor1.x - this.m_localCenterA.x,
            ...
            l = x.col1.x * B + x.col2.x *
            E,
            E = x.col1.y * B + x.col2.y * E,
            B = l;
        x = y;
        y = this.m_localAnchor2.x - this.m_localCenterB.x;
        r = this.m_localAnchor2.y - this.m_localCenterB.y;
        l = x.col1.x * y + x.col2.x * r;
        r = x.col1.y * y + x.col2.y * r;
        y = l;
        x = n.x + y - j.x - B;
        l = n.y + r - j.y - E;
        if (this.m_enableLimit) {
            this.m_axis = e.MulMV(D, this.m_localXAxis1);
            this.m_a1 = (x + B) * this.m_axis.y - (l + E) * this.m_axis.x;
            this.m_a2 = y * this.m_axis.y - r * this.m_axis.x;
            var G = this.m_axis.x * x + this.m_axis.y * l;
    ...
    M.prototype.InitVelocityConstraints = function(c) {
        ...
        this.m_K.col3.z = m + n + l * this.m_a1 *
        ...
        this.m_enableLimit ? (g = this.m_axis.x * g + this.m_axis.y * j, e.Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b.b2_linearSlop ? this.m_limitState = B.e_equalLimits : g <= this.m_lowerTranslation ? this.m_limitState != B.e_atLowerLimit && (this.m_limitState = B.e_atLowerLimit, this.m_impulse.z = 0) : g >= this.m_upperTranslation ? this.m_limitState != B.e_atUpperLimit && (this.m_limitState = B.e_atUpperLimit, this.m_impulse.z = 0) : (this.m_limitState = B.e_inactiveLimit, this.m_impulse.z = 0)) : this.m_limitState =
            B.e_inactiveLimit;
        !1 == this.m_enableMotor && (this.m_motorImpulse = 0);
        c.warmStarting ? (this.m_impulse.x *= c.dtRatio, this.m_impulse.y *= c.dtRatio, this.m_motorImpulse *= c.dtRatio, c = this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.x, g = this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.y, j = this.m_impulse.x * this.m_s1 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a1, m = this.m_impulse.x * this.m_s2 + this.m_impulse.y + (this.m_motorImpulse +
            this.m_impulse.z) * this.m_a2, d.m_linearVelocity.x -= this.m_invMassA * c, d.m_linearVelocity.y -= this.m_invMassA * g, d.m_angularVelocity -= this.m_invIA * j, f.m_linearVelocity.x += this.m_invMassB * c, f.m_linearVelocity.y += this.m_invMassB * g, f.m_angularVelocity += this.m_invIB * m) : (this.m_impulse.SetZero(), this.m_motorImpulse = 0)
    };
    ...
    M.prototype.SolvePositionConstraints = function() {
        ...
        if (this.m_enableLimit) {
            ...
            e.Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b.b2_linearSlop ? (A = e.Clamp(I, -b.b2_maxLinearCorrection,
        ...
        G = this.m_perp.x * y + this.m_perp.y *
            l;
        E = x - n - this.m_refAngle;
        r = e.Max(r, e.Abs(G));
        B = e.Abs(E);
        q ? (q = this.m_invMassA, z = this.m_invMassB, y = this.m_invIA, l = this.m_invIB, this.m_K.col1.x = q + z + y * this.m_s1 * this.m_s1 + l * this.m_s2 * this.m_s2, this.m_K.col1.y = y * this.m_s1 + l * this.m_s2, this.m_K.col1.z = y * this.m_s1 * this.m_a1 + l * this.m_s2 * this.m_a2, this.m_K.col2.x = this.m_K.col1.y, this.m_K.col2.y = y + l, this.m_K.col2.z = y * this.m_a1 + l * this.m_a2, this.m_K.col3.x = this.m_K.col1.z, this.m_K.col3.y = this.m_K.col2.z, this.m_K.col3.z = q + z + y * this.m_a1 * this.m_a1 + l * this.m_a2 * this.m_a2,
            this.m_K.Solve33(D, -G, -E, -A)) : (q = this.m_invMassA, z = this.m_invMassB, y = this.m_invIA, l = this.m_invIB, A = y * this.m_s1 + l * this.m_s2, I = y + l, this.m_K.col1.Set(q + z + y * this.m_s1 * this.m_s1 + l * this.m_s2 * this.m_s2, A, 0), this.m_K.col2.Set(A, I, 0), A = this.m_K.Solve22(new f, -G, -E), D.x = A.x, D.y = A.y, D.z = 0);
        ...
        d.SynchronizeTransform();
        g.SynchronizeTransform();
        return r <= b.b2_linearSlop && B <= b.b2_angularSlop
    };
    ...
    J.prototype.b2PulleyJoint = function(b) {
        ...
        this.m_maxLength1 = e.Min(b.maxLengthA, this.m_constant - this.m_ratio * J.b2_minPulleyLength);
        this.m_maxLength2 = e.Min(b.maxLengthB, (this.m_constant - J.b2_minPulleyLength) / this.m_ratio);
    ...
    J.prototype.InitVelocityConstraints = function(c) {
        ...
        m > b.b2_linearSlop ?
            this.m_u2.Multiply(1 / m) : this.m_u2.SetZero();
        ...
        this.m_limitMass2 =
            e.m_invMass + e.m_invI * m * m;
        this.m_pulleyMass = this.m_limitMass1 + this.m_ratio * this.m_ratio * this.m_limitMass2;
        this.m_limitMass1 = 1 / this.m_limitMass1;
        this.m_limitMass2 = 1 / this.m_limitMass2;
        this.m_pulleyMass = 1 / this.m_pulleyMass;
        c.warmStarting ? (this.m_impulse *= c.dtRatio, this.m_limitImpulse1 *= c.dtRatio, this.m_limitImpulse2 *= c.dtRatio, c = (-this.m_impulse - this.m_limitImpulse1) * this.m_u1.x, f = (-this.m_impulse - this.m_limitImpulse1) * this.m_u1.y, m = (-this.m_ratio * this.m_impulse - this.m_limitImpulse2) * this.m_u2.x, t = (-this.m_ratio *
    ...
    J.prototype.SolveVelocityConstraints = function() {
        ...
        var m = this.m_localAnchor2.x - c.m_sweep.localCenter.x,
            ...
            n = 0,
            t = 0;
        this.m_state == B.e_atUpperLimit && (d = b.m_linearVelocity.x + -b.m_angularVelocity * g, j = b.m_linearVelocity.y + b.m_angularVelocity * f, n = c.m_linearVelocity.x + -c.m_angularVelocity * l, t = c.m_linearVelocity.y + c.m_angularVelocity * m, d = -(this.m_u1.x * d + this.m_u1.y * j) - this.m_ratio *
        ...
        this.m_limitState2 == B.e_atUpperLimit && (n = c.m_linearVelocity.x + -c.m_angularVelocity * l, t = c.m_linearVelocity.y + c.m_angularVelocity * m,
            d = -(this.m_u2.x * n + this.m_u2.y * t), t = -this.m_limitMass2 * d, d = this.m_limitImpulse2, this.m_limitImpulse2 = e.Max(0, this.m_limitImpulse2 + t), t = this.m_limitImpulse2 - d, n = -t * this.m_u2.x, t = -t * this.m_u2.y, c.m_linearVelocity.x += c.m_invMass * n, c.m_linearVelocity.y += c.m_invMass * t, c.m_angularVelocity += c.m_invI * (m * t - l * n))
    };
    J.prototype.SolvePositionConstraints = function() {
        ...
        this.m_state == B.e_atUpperLimit && (f = c.m_xf.R, l = this.m_localAnchor1.x - c.m_sweep.localCenter.x, q = this.m_localAnchor1.y - c.m_sweep.localCenter.y, x = f.col1.x * l + f.col2.x * q, q = f.col1.y * l + f.col2.y * q, l = x, f = d.m_xf.R, t = this.m_localAnchor2.x - d.m_sweep.localCenter.x, r = this.m_localAnchor2.y - d.m_sweep.localCenter.y, x = f.col1.x * t + f.col2.x * r, r = f.col1.y * t + f.col2.y * r, t = x, f = c.m_sweep.c.x +
            ...
            c.m_invMass * f, c.m_sweep.c.y += c.m_invMass * x, c.m_sweep.a += c.m_invI * (l * x - q * f), d.m_sweep.c.x += d.m_invMass * y, d.m_sweep.c.y += d.m_invMass * z, d.m_sweep.a += d.m_invI * (t * z - r * y), c.SynchronizeTransform(), d.SynchronizeTransform());
        this.m_limitState1 == B.e_atUpperLimit && (f = c.m_xf.R, l = this.m_localAnchor1.x - c.m_sweep.localCenter.x, q = this.m_localAnchor1.y - c.m_sweep.localCenter.y, x = f.col1.x * l + f.col2.x * q, q = f.col1.y * l + f.col2.y * q, l = x, f = c.m_sweep.c.x + l, x = c.m_sweep.c.y + q, this.m_u1.Set(f - g, x - j), f = this.m_u1.Length(), f > b.b2_linearSlop ?
            (this.m_u1.x *= 1 / f, this.m_u1.y *= 1 / f) : this.m_u1.SetZero(), f = this.m_maxLength1 - f, A = e.Max(A, -f), f = e.Clamp(f + b.b2_linearSlop, -b.b2_maxLinearCorrection, 0), z = -this.m_limitMass1 * f, f = -z * this.m_u1.x, x = -z * this.m_u1.y, c.m_sweep.c.x += c.m_invMass * f, c.m_sweep.c.y += c.m_invMass * x, c.m_sweep.a += c.m_invI * (l * x - q * f), c.SynchronizeTransform());
        this.m_limitState2 == B.e_atUpperLimit && (f = d.m_xf.R, t = this.m_localAnchor2.x - d.m_sweep.localCenter.x, r = this.m_localAnchor2.y - d.m_sweep.localCenter.y, x = f.col1.x * t + f.col2.x * r, r = f.col1.y *
            t + f.col2.y * r, t = x, y = d.m_sweep.c.x + t, z = d.m_sweep.c.y + r, this.m_u2.Set(y - m, z - n), x = this.m_u2.Length(), x > b.b2_linearSlop ? (this.m_u2.x *= 1 / x, this.m_u2.y *= 1 / x) : this.m_u2.SetZero(), f = this.m_maxLength2 - x, A = e.Max(A, -f), f = e.Clamp(f + b.b2_linearSlop, -b.b2_maxLinearCorrection, 0), z = -this.m_limitMass2 * f, y = -z * this.m_u2.x, z = -z * this.m_u2.y, d.m_sweep.c.x += d.m_invMass * y, d.m_sweep.c.y += d.m_invMass * z, d.m_sweep.a += d.m_invI * (t * z - r * y), d.SynchronizeTransform());
    ...
    O.prototype.InitVelocityConstraints = function(c) {
        ...
        !1 == this.m_enableMotor && (this.m_motorImpulse = 0);
        if (this.m_enableLimit) {
            var x = f.m_sweep.a - d.m_sweep.a - this.m_referenceAngle;
            e.Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * b.b2_angularSlop ? this.m_limitState = B.e_equalLimits : x <= this.m_lowerAngle ? (this.m_limitState != B.e_atLowerLimit && (this.m_impulse.z = 0), this.m_limitState =
                B.e_atLowerLimit) : x >= this.m_upperAngle ? (this.m_limitState != B.e_atUpperLimit && (this.m_impulse.z = 0), this.m_limitState = B.e_atUpperLimit) : (this.m_limitState = B.e_inactiveLimit, this.m_impulse.z = 0)
        } else this.m_limitState = B.e_inactiveLimit;
        c.warmStarting ? (this.m_impulse.x *= c.dtRatio, this.m_impulse.y *= c.dtRatio, this.m_motorImpulse *= c.dtRatio, c = this.m_impulse.x, x = this.m_impulse.y, d.m_linearVelocity.x -= g * c, d.m_linearVelocity.y -= g * x, d.m_angularVelocity -= t * (m * x - n * c + this.m_motorImpulse + this.m_impulse.z), f.m_linearVelocity.x +=
            j * c, f.m_linearVelocity.y += j * x, f.m_angularVelocity += r * (l * x - q * c + this.m_motorImpulse + this.m_impulse.z)) : (this.m_impulse.SetZero(), this.m_motorImpulse = 0)
    };
    O.prototype.SolveVelocityConstraints = function(b) {
        var c = this.m_bodyA,
            ...
            x = d.m_angularVelocity,
            y = c.m_invMass,
            z = d.m_invMass,
            A = c.m_invI,
            D = d.m_invI;
        this.m_enableMotor && this.m_limitState != B.e_equalLimits && (g = this.m_motorMass * -(x - t - this.m_motorSpeed), j = this.m_motorImpulse,
            m = b.dt * this.m_maxMotorTorque, this.m_motorImpulse = e.Clamp(this.m_motorImpulse + g, -m, m), g = this.m_motorImpulse - j, t -= A * g, x += D * g);
        if (this.m_enableLimit && this.m_limitState != B.e_inactiveLimit) {
            ...
            m =
                f;
            b = r.x + -x * l - n.x - -t * j;
            var E = r.y + x * m - n.y - t * g;
            this.m_mass.Solve33(this.impulse3, -b, -E, -(x - t));
            ...
            r.x += z * this.impulse3.x;
            r.y += z * this.impulse3.y;
            x += D * (m * this.impulse3.y - l * this.impulse3.x + this.impulse3.z)
            ...
            r.x += z * this.impulse2.x, r.y += z * this.impulse2.y, x += D * (m * this.impulse2.y - l * this.impulse2.x);
    ...
    O.prototype.SolvePositionConstraints = function() {
        ...
        x > D * D && (x = 1 / (m + y), n = x * -n, l = x * -l, f.m_sweep.c.x -= 0.5 * m * n, f.m_sweep.c.y -=
            0.5 * m * l, g.m_sweep.c.x += 0.5 * y * n, g.m_sweep.c.y += 0.5 * y * l, n = g.m_sweep.c.x + t - f.m_sweep.c.x - q, l = g.m_sweep.c.y + r - f.m_sweep.c.y - c);
        this.K1.col1.x = m + y;
        this.K1.col2.x = 0;
        this.K1.col1.y = 0;
        this.K1.col2.y = m + y;
    ...
    ba.prototype.SolvePositionConstraints = function() {
        ...
        var d = g.m_invMass,
            ...
            y = g.m_sweep.c.y + l - f.m_sweep.c.y - n,
            ...
            D = e.Abs(z);
        B > A && (q *= 1, x *= 1);
        this.m_mass.col1.x = c + d + n * n * q + l * l * x;
        this.m_mass.col2.x = -n * m * q - l * t * x;
        this.m_mass.col3.x = -n * q - l * x;
        this.m_mass.col1.y = this.m_mass.col2.x;
        this.m_mass.col2.y = c + d + m * m * q + t * t * x;
        this.m_mass.col3.y = m * q + t * x;
        this.m_mass.col1.z = this.m_mass.col3.x;
        this.m_mass.col2.z = this.m_mass.col3.y;
        this.m_mass.col3.z = q + x;
        A = new j;
        this.m_mass.Solve33(A, -r, -y, -z);
        f.m_sweep.c.x -= c * A.x;
        f.m_sweep.c.y -= c * A.y;
...
ig.module("plugins.box2d.game").requires("plugins.box2d.lib", "impact.game").defines(function() {
    ig.Box2DGame = ig.Game.extend({
        ...
        worldVelocityIterations: 30,
        worldPositionIterations: 30,
        updateTimestep: 1 / 60,
            ...
            for (var d = [], e = [], f = 0; f < b.length; f++) {
                ...
                if (!(-1 < d.indexOf(j)))
                    if (d.push(j), -1 < j.neighbours.indexOf("right")) {
                        ...
                        for (var t = c[j.tile.y][n].settings.vertices, z = 0; z < t.length; z++) t[z].x *= g + 1;
                    ...
                    for (n = 1; !0 == this.sideAbleCheck(c, j.tile.x, j.tile.y + n, "down") && !1 == this.sideAbleCheck(c, j.tile.x, j.tile.y + n, "right") && !1 == this.sideAbleCheck(c,
                            j.tile.x, j.tile.y + n, "left");) t = 1, d.push(c[j.tile.y + n][j.tile.x]), n++;
                    ...
                    if (1 == t) {
                        ...
                        for (z = 0; z < t.length; z++) t[z].y *= n + 1;
                ...
                if (b = b.tiledef[c]) {
                    ...
                    if (1 > Math.abs(n) && 1 > Math.abs(m)) {
                        var n = _utv2.pointQuadrant(b, e, 0.5, 0.5),
                            ...
                            y = _utv2.pointQuadrant(t, g, 0.5, 0.5);
                        !(n & y) && !(m & y) && (z = !0)
                    }!0 === z ? (t !== g ? (z = t, m = g, 1 == t ? (g = 1, n = 0) : (g = 0, n = 1)) : (n = t, m = 1 == t ? z = 0 : z = 1), d[3] = {
                        x: z,
                        y: g
                    }, d[4] = {
                        x: n,
                        ...
                        t, m = g, 1 == t ? (g = Math.max(e, f), n = Math.min(b, j)) : (g = Math.min(e, f), n = Math.max(b, j))) : (n = t, 1 == t ? (z = Math.min(b, j), m = Math.min(e, f)) : (z = Math.max(b, j), m = Math.max(e, f))), z === b && g === e || z === j && g === f ? n === b && m === e || n === j && m === f || (d[3] = {
                        x: n,
                        y: m
                    }) : d[3] = {
                        x: z,
...
ig.module("plugins.box2d.entity").requires("impact.entity", "plugins.box2d.game").defines(function() {
    ig.Box2DEntity = ig.Entity.extend({
        ...
        createBody: function() {
            ...
            b.position = new Box2D.Common.Math.b2Vec2((this.pos.x + this.size.x / 2) * Box2D.SCALE,
    ...
    EntityPointer = ig.Entity.extend({
        ...
        update: function() {
            ...
            if (null != b) null != this.hoveringItem ? this.hoveringItem != b && ("function" == typeof this.hoveringItem.leave && this.hoveringItem.leave(), "function" == typeof b.over && b.over()) : "function" == typeof b.over && b.over(), this.hoveringItem = b, this.clickObject(b), this.objectArray = [];
                ...
                for (b = 0; b < this.clickedObjectList.length; b++) c = this.clickedObjectList[b], "function" == typeof c.releasedOutside &&
                    c.releasedOutside();
...
ig.module("game.entities.buttons.button-play").requires("game.entities.buttons.button").defines(function() {
    EntityButtonPlay = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/play-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.pos.x = this.X0 = ig.game.centerX - this.animImage.width / 2;
            this.pos.y = this.Y0 = ig.system.height + this.animImage.height / 2;
            this.tweensPos()
        },
        callback: function() {
...
ig.module("game.ui.popup").requires("impact.entity").defines(function() {
    EntityPopup = ig.Entity.extend({
        ...
        init: function(b, c, d) {
            ...
            this.easingIn = d.easingIn ? d.easingIn : ig.Tween.Easing.Back.EaseIn;
            this.easingOut = d.easingOut ? d.easingOut : ig.Tween.Easing.Back.EaseOut;
            this.setAnim();
            this.pos.x = (ig.system.width - this.size.x) / 2 + ig.game.screen.x;
            this.pos.y = -this.size.y - this.dY +
                ig.game.screen.y;
            this.y0 = (ig.system.height - this.size.y) / 2 + ig.game.screen.y;
            this.titleX = ig.game.centerX + ig.game.screen.x;
...
ig.module("game.ui.slider").requires("impact.entity").defines(function() {
    EntitySlider = ig.Entity.extend({
        collides: ig.Entity.COLLIDES.NEVER,
        type: ig.Entity.TYPE.A,
        bar0: new ig.Image("media/graphics/games/ui/bar0.png"),
        bar1: new ig.Image("media/graphics/games/ui/bar1.png"),
...
ig.baked = !0;
ig.module("game.entities.buttons.button-ok").requires("game.entities.buttons.button").defines(function() {
    EntityButtonOk = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/back-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        callback: function() {
...
ig.module("game.ui.popup-settings").requires("game.ui.popup", "game.ui.slider-sound", "game.ui.slider-music", "game.entities.buttons.button-ok").defines(function() {
    EntityPopupSettings = EntityPopup.extend({
        image: new ig.Image("media/graphics/games/background/bg1.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            ig.game.currentLayer = ig.game.layers.POPUP;
            this.easingIn = d.easingIn ? d.easingIn : ig.Tween.Easing.Quintic.EaseOut;
            d.easingOut ? ig.Tween.Easing.Exponential.EaseIn : this.easingOut = ig.Tween.Easing.Quintic.EaseIn;
            this.sliderSound = this.spawnEntity(EntitySliderSound, this.pos.x + 130, 0);
            this.sliderMusic = this.spawnEntity(EntitySliderMusic, this.pos.x + 130, 0);
            ...
            _SETTINGS.MoreGames.Enabled && this.btMoreGames.hide();
            this.moveIn();
            ig.game.sortEntitiesDeferred()
        },
        update: function() {
            this.parent();
            this.sliderSound.pos.y = this.pos.y + 220;
            this.sliderMusic.pos.y = this.pos.y + 330;
            this.btOK.pos.y = this.pos.y + 480;
            this.titleY = this.pos.y + 100
        },
        draw: function() {
            this.parent();
            ig.game.drawText(this.title, this.titleX, this.titleY, 60, "#FFF", "center")
        },
        moveIn: function() {
            var b = this;
            this.tween({
        ...
        callback: function() {
            _SETTINGS.MoreGames.Enabled && this.btMoreGames.show()
        }
    })
});
ig.baked = !0;
ig.module("game.entities.buttons.button-settings").requires("game.entities.buttons.button", "game.ui.popup-settings").defines(function() {
    EntityButtonSettings = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/setting-btn.png"),
        alpha: 0,
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.buttons.button-arrow").requires("game.entities.buttons.button").defines(function() {
    EntityButtonArrow = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/prevnext-btn.png"),
        isNext: !0,
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.buttons.button-home").requires("game.entities.buttons.button").defines(function() {
    EntityButtonHome = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/home-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        callback: function() {
    ...
    EntityButtonHomeEnd = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/home-btn-game-end.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        callback: function() {
...
ig.module("game.entities.buttons.button-replay").requires("game.entities.buttons.button").defines(function() {
    EntityButtonReplay = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/retry-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        callback: function() {
...
ig.baked = !0;
ig.module("game.ui.popup-pause").requires("game.ui.popup", "game.ui.slider-sound", "game.ui.slider-music", "game.entities.buttons.button-home", "game.entities.buttons.button-replay", "game.entities.buttons.button-continue").defines(function() {
    EntityPopupPause = EntityPopup.extend({
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.sliderSound = this.spawnEntity(EntitySliderSound, this.pos.x + 105, 0);
            this.sliderMusic = this.spawnEntity(EntitySliderMusic, this.pos.x + 105, 0);
            this.btHome = this.spawnEntity(EntityButtonHome,
                ig.game.centerX - 100, 0);
            this.btReplay = this.spawnEntity(EntityButtonReplay, ig.game.centerX, 0);
            this.btContinue = this.spawnEntity(EntityButtonContinue, ig.game.centerX + 100, 0);
            this.title = _STRINGS.Game.GamePause;
            ig.game.sortEntitiesDeferred()
        },
        update: function() {
            this.parent();
            this.sliderSound.pos.y = this.pos.y + 220;
            this.sliderMusic.pos.y = this.pos.y + 330;
            this.btHome.pos.y = this.btReplay.pos.y = this.btContinue.pos.y = this.pos.y + 230
        }
    })
});
ig.baked = !0;
ig.module("game.entities.buttons.button-select-buy").requires("game.entities.buttons.button", "game.ui.popup-pause").defines(function() {
    EntityButtonSelectBuy = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/select-buy-btn.png"),
        withText: !0,
        itemID: 0,
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.buttonText = _STRINGS.Game.Use
        }
    })
});
ig.baked = !0;
ig.module("game.entities.buttons.button-items").requires("game.entities.buttons.button", "game.entities.buttons.button-select-buy").defines(function() {
    EntityButtonItems = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/balloon-frame.png"),
        items: [new ig.Image("media/graphics/games/ui/shop/original.png"), new ig.Image("media/graphics/games/ui/shop/ombre.png"), new ig.Image("media/graphics/games/ui/shop/chevron.png"), new ig.Image("media/graphics/games/ui/shop/polcadot.png"), new ig.Image("media/graphics/games/ui/shop/panda.png"),
            new ig.Image("media/graphics/games/ui/shop/donut.png"), new ig.Image("media/graphics/games/ui/shop/moustache.png"), new ig.Image("media/graphics/games/ui/shop/moustache.png")
        ],
        withText: !0,
        buttonText: "X",
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.buttonText = _STRINGS.ItemsBalloon[this.vid.toString()]
        },
        draw: function() {
            this.parent();
            var b = -this.size.x / 2 + 35,
                c = -this.size.y / 2 + 25,
                d = ig.system.context;
            d.save();
            d.translate(ig.system.getDrawPos(this.pos.x.round() - ig.game.screen.x + this.size.x / 2 - this.offset.x),
                ig.system.getDrawPos(this.pos.y.round() - ig.game.screen.y + this.size.y / 2 - this.offset.y));
            d.scale(this.scale.x, this.scale.y);
            this.items[this.vid - 1].draw(b, c);
            d.restore()
        },
        drawText: function() {
            ig.game.drawText(this.buttonText, this.pos.x - 110, 10, 25, "#FFF", "left")
        },
        callback: function() {}
    })
});
ig.baked = !0;
ig.module("game.ui.popup-shop").requires("game.ui.popup", "game.entities.buttons.button-arrow", "game.entities.buttons.button-home", "game.entities.buttons.button-items").defines(function() {
    EntityPopupShop = EntityPopup.extend({
        image: new ig.Image("media/graphics/games/background/bg1.png"),
        da: 0.05,
        alpha: 1,
        fadeIn: !1,
        ...
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.title = _STRINGS.Game.Shop;
            this.buttonHome = this.spawnEntity(EntityButtonHome, 50, 15);
            this.btMoreGames = ig.game.getEntitiesByType(EntityButtonMoreGames)[0];
            this.btMoreGames.hide();
            b = (ig.system.height - 290) / 3 - 50;
            for (c = 0; 4 > c; c++)
                for (d = 0; 1 > d; d++) {
                    var e = 145 + c * b;
                    this.cellItems.push(this.spawnEntity(EntityButtonItems, 265, e, {
                        vid: c + 1
                    }));
                    this.btUse.push(this.spawnEntity(EntityButtonSelectBuy, 415, e + 115, {
                        vid: c + 1
                    }))
                }
            this.totalItems = this.cellItems.length;
            4 == this.totalItems && (this.btNext = this.spawnEntity(EntityButtonArrow, this.pos.x + this.size.x - 130, 0), this.btPrev = this.spawnEntity(EntityButtonArrow, this.pos.x + 130, 0, {
                    isNext: !1
                }), this.btPrev.setShown(!1), this.btArrowDY =
                this.size.y - 125);
            ig.game.sortEntitiesDeferred()
        },
        update: function() {
            this.parent();
            this.titleY = this.pos.y + this.titleDY;
            this.buttonHome.pos.y = this.pos.y + 15;
            var b = 0;
            4 == this.totalItems && (this.btNext.pos.y = this.btPrev.pos.y = this.pos.y + this.btArrowDY);
            for (var c = 0; 4 > c; c++)
                for (var d = 0; 1 > d; d++) {
                    var e = 145 + c * ((ig.system.height - 290) / 3 - 50),
                        f = this.cellItems[b],
                        j = this.btUse[b];
                    f.pos.x = this.pos.x + 265 - 200;
                    f.pos.y = this.pos.y + e;
                    j.pos.x = this.pos.x + 265 + 97;
                    j.pos.y = this.pos.y + e + 115;
                    b++
                }
            this.fadeOut ? (b = this.alpha - this.da,
                0 < b ? this.alpha = b : (this.alpha = 0, this.fadeOut = !1, this.fadeIn = !0)) : this.fadeIn && (b = this.alpha + this.da, 1 > b ? this.alpha = b : (this.alpha = 1, this.fadeIn = !1))
        },
        callback: function() {
            this.btMoreGames.show()
        },
        draw: function() {
            this.parent();
            var b = ig.system.width - 100;
            ig.game.drawText(this.title, this.titleX, this.titleY, 60, "#FFF", "center");
            ig.game.drawText(_STRINGS.Game.Coins, b, 37, 24, "#FFF", "center");
            ig.game.drawText(ig.game.coins, b + 40, 37, 24, "#FFF", "left");
            ig.system.context.save();
            ig.system.context.globalAlpha = this.alpha;
            ig.system.context.restore()
        },
        goNext: function() {
            for (var b = 0; b < this.cellItems.length; b++) this.cellItems[b].vid += 4;
            this.btNext.setShown(!1);
            this.btPrev.setShown(!0);
            this.fadeOut = !0
        },
        goPrev: function() {
            for (var b = 0; b < this.cellItems.length; b++) this.cellItems[b].vid -= 4;
            this.btPrev.setShown(!1);
            this.btNext.setShown(!0);
            this.fadeOut = !0
        }
    })
});
ig.baked = !0;
ig.module("game.entities.buttons.button-shop").requires("game.entities.buttons.button", "game.ui.popup-shop").defines(function() {
    EntityButtonShop = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/shop-btn.png"),
        alpha: 0,
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.currentAnim.alpha = 0;
        ...
        callback: function() {
            ig.game.spawnEntity(EntityPopupShop, 0, 0)
        },
        fadeIn: function() {
            this.tween({
                currentAnim: {
...
ig.baked = !0;
ig.module("game.entities.gentities.title").requires("impact.entity").defines(function() {
    EntityTitle = ig.Entity.extend({
        images: new ig.Image("media/graphics/games/ui/title.png"),
        zIndex: 100,
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.setupAnim();
...
ig.baked = !0;
ig.module("game.entities.controllers.home-controller").requires("game.entities.buttons.button-play", "game.entities.buttons.button-settings", "game.entities.buttons.button-more-games", "game.entities.buttons.button-shop", "game.entities.gentities.title").defines(function() {
    EntityHomeController = ig.Entity.extend({
        bg: new ig.Image("media/graphics/games/background/bg1.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            ig.game.currentLayer = ig.game.layers.BASE;
            0 == ig.game.getEntitiesByType(EntityPointer).length && ig.game.spawnEntity(EntityPointer,
                0, 0);
            b = ig.game.centerX;
            this.spawnEntity(EntityButtonPlay, 0, 0);
            this.spawnEntity(EntityButtonSettings, b + 85, 595);
            this.spawnEntity(EntityButtonMoreGames, b - 85, 595);
            ig.game.spawnEntity(ig.FullscreenButton, 10, 5, {
                enterImage: new ig.Image("media/graphics/games/ui/enter-fullscreen-transparent.png"),
                exitImage: new ig.Image("media/graphics/games/ui/exit-fullscreen-transparent.png")
            });
            this.spawnEntity(EntityTitle, b - 200, 0);
            ig.game.spawnEntity(EntityFade, 0, 0);
            ig.game.sortEntitiesDeferred()
        },
        draw: function() {
...
ig.baked = !0;
ig.module("game.entities.buttons.button-pause").requires("game.entities.buttons.button", "game.ui.popup-pause").defines(function() {
    EntityButtonPause = EntityButton.extend({
        animImage: new ig.Image("media/graphics/games/ui/pause-btn.png"),
        init: function(b, c, d) {
            this.parent(b, c, d)
        },
        update: function() {
...
ig.baked = !0;
ig.module("game.ui.popup-gameover").requires("game.ui.popup", "game.entities.buttons.button-home", "game.entities.buttons.button-replay").defines(function() {
    EntityPopupGameOver = EntityPopup.extend({
        image: new ig.Image("media/graphics/games/background/bg1.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.title = _STRINGS.Game.Woops;
            this.btDY = this.size.y - 500;
            this.btHome = this.spawnEntity(EntityButtonHomeEnd, ig.game.centerX - 80, this.pos.y + this.btDY - ig.game.screen.y);
            this.btReplay = this.spawnEntity(EntityButtonReplay,
                ig.game.centerX + 80, this.pos.y + this.btDY - ig.game.screen.y);
            ig.game.sortEntitiesDeferred();
            this.highscore = ig.game.load("highscore");
            ig.game.score > this.highscore ? (ig.game.save("highscore", ig.game.score), this.isHighscore = !0, setTimeout(function() {
                ig.soundHandler.sfxPlayer.play("win")
            }, 1500)) : (this.isHighscore = !1, setTimeout(function() {
                ig.soundHandler.sfxPlayer.play("lose")
            }, 1500));
            this.leftX = ig.game.centerX;
            this.rightX = ig.game.centerX + 60;
            this.textDY = 192 - ig.game.screen.y;
            this.textDY2 = 237 - ig.game.screen.y
        },
        update: function() {
            this.parent();
        ...
        moveIn: function() {
            ig.game.getEntitiesByType(EntityGameController)[0].gameOver = !0;
            var b = this;
            this.tween({
                pos: {
                    y: this.y0
        ...
        draw: function() {
            this.parent();
            ig.game.drawText(_STRINGS.Game.Woops, this.titleX, this.pos.y + this.textDY + 48, 65, "#fff", "center");
            this.isHighscore ? (ig.game.drawText(_STRINGS.Game.Score, this.leftX, this.pos.y +
                ...
                ig.game.drawText(_STRINGS.Game.HighScore, this.leftX, this.pos.y + this.textDY2 + 155, 40, "#fff", "right"), ig.game.drawText(this.highscore, this.rightX - 15, this.pos.y + this.textDY2 + 155, 40, "#fff", "left"))
        }
    })
});
ig.baked = !0;
ig.module("game.entities.gentities.rolling-bg").requires("impact.entity").defines(function() {
    EntityRollingBg = ig.Entity.extend({
        cloud: new ig.Image("media/graphics/games/background/cloud.png"),
        zIndex: 1,
        speed: 0,
        valpha: 0,
        drawText: !0,
        checkScore: !0,
        colors: "#5E5ECC #F76995 #777270 #EF8A3F #8CDDF5 #79C753 #FAE03C".split(" "),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.timer = new ig.Timer(0.1);
            this.timer.pause();
            this.height0 = ig.system.height + 10;
            this.y0 = 0;
            this.color1 = this.getRandomColor();
            this.color2 = this.getRandomColor();
            this.dY0 = this.height0 - this.cloud.height + 90;
            ig.game.sortEntitiesDeferred()
        },
        update: function() {
            this.parent();
            if (!ig.game.getEntitiesByType(EntityGameController)[0].gameOver) {
                ig.input.pressed("click") && this.drawText && (this.speed = 3.5, this.drawText = !1, this.timer.unpause());
                35 < ig.game.score && this.checkScore && (this.speed = 1.5, this.checkScore = !1);
                0 < this.timer.delta() && (ig.game.score++, this.timer.reset());
                var b = this.y0 + this.speed;
                b >= ig.system.height ? (this.y0 = b - this.height0, this.color1 = this.color2, this.color2 =
                    this.getRandomColor()) : this.y0 = b
            }
        },
        ...
        draw: function() {
            var b = ig.system.context;
            b.fillStyle = this.color1;
            b.fillRect(0, this.y0, ig.system.width, this.height0);
            this.cloud.draw(0, this.y0 + this.dY0);
            b.fillStyle = this.color2;
            b.fillRect(0, this.y0 - this.height0, ig.system.width, this.height0);
            this.drawText && this.drawFirstText();
            this.cloud.draw(0, this.y0 - this.height0 + this.dY0);
            this.cloud.draw(0, this.y0 - 2 * this.height0 + this.dY0)
        },
        drawFirstText: function() {
            ig.game.drawText(_STRINGS.Game.Protect, 270, 600, 30, "#FFF", "center")
        }
    })
});
ig.baked = !0;
ig.module("game.entities.gentities.failed").requires("impact.entity").defines(function() {
    EntityFailed = ig.Entity.extend({
        zIndex: 100,
        init: function(b, c, d) {
            this.parent(b, c, d);
            for (b = 0; 50 > b; b++) this.spawnEntity(EntityBalloons, this.getCenterX(), this.getCenterY());
            ig.game.sortEntitiesDeferred()
        }
    });
    EntityBalloons = ig.Entity.extend({
        image: [new ig.Image("media/graphics/games/ui/shop/original.png"), new ig.Image("media/graphics/games/ui/shop/ombre.png"), new ig.Image("media/graphics/games/ui/shop/chevron.png"),
            new ig.Image("media/graphics/games/ui/shop/polcadot.png"), new ig.Image("media/graphics/games/ui/shop/panda.png"), new ig.Image("media/graphics/games/ui/shop/donut.png"), new ig.Image("media/graphics/games/ui/shop/moustache.png")
        ],
        lifeTime: 1.5,
        maxVel: {
            x: 1E3,
        ...
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.halfWidth = this.image[ig.game.currentID].width / 2;
            this.halfHeight = this.image[ig.game.currentID].height / 2;
            this.scale = 0.9 * Math.random() + 0.1;
            b = -Math.random() * Math.PI;
            c = 500 * Math.random() + 200;
            this.vel.x =
                c * Math.cos(b);
            this.vel.y = c * Math.sin(b);
        ...
        draw: function() {
            ...
            b.translate(this.getCenterX(), this.getCenterY());
            b.scale(this.scale, this.scale);
            this.image[ig.game.currentID].draw(-this.halfWidth, -this.halfHeight);
            b.restore()
        }
    })
});
ig.baked = !0;
ig.module("game.entities.gentities.balloon").requires("plugins.box2d.entity", "game.entities.gentities.failed", "game.ui.popup-gameover").defines(function() {
    EntityBalloon = ig.Box2DEntity.extend({
        type: ig.Entity.TYPE.A,
        balloon: [new ig.Image("media/graphics/games/play/original.png"), new ig.Image("media/graphics/games/play/ombre.png"), new ig.Image("media/graphics/games/play/chevron.png"), new ig.Image("media/graphics/games/play/polcadot.png"), new ig.Image("media/graphics/games/play/panda.png"), new ig.Image("media/graphics/games/play/donut.png"),
            new ig.Image("media/graphics/games/play/moustache.png")
        ],
        zIndex: 1E3,
        box2dType: 2,
        dynamicType: 1,
        ...
        update: function() {
            if (!this.parents.gameOver) {
                this.parent();
                ig.input.pressed("click") && this.clickedBaloon && (this.speedY = 3.5, this.clickedBaloon = !1);
                35 < ig.game.score && this.checkScore && (this.speedY = 1.5, this.checkScore = !1);
                var b = this.body.GetPosition();
                b.y -= this.speedY * Box2D.SCALE;
                this.body.SetPosition(b);
                ig.game.screen.y = b.y / Box2D.SCALE + 150 - ig.system.height
            }
        },
        setupAnim: function() {
            var b = this.balloon[ig.game.currentID];
            this.animSheet = new ig.AnimationSheet(b.path,
                b.width, b.height);
        ...
        beginContact: function(b) {
            b && b.isObstacle && (this.kill(), this.failed = ig.game.spawnEntity(EntityFailed, ig.game.centerX, ig.system.height - 220), this.showGameOver())
        },
        showGameOver: function() {
            this.gameOver && (this.gameOver = !1, ig.game.spawnEntity(EntityPopupGameOver, 0, 0), ig.soundHandler.sfxPlayer.play("over"))
        }
    })
});
ig.baked = !0;
ig.module("game.entities.gentities.protect").requires("plugins.box2d.entity").defines(function() {
    EntityProtect = ig.Box2DEntity.extend({
        type: ig.Entity.TYPE.B,
        checkAgainst: ig.Entity.TYPE.BOTH,
        protect: new ig.Image("media/graphics/games/play/protect.png"),
        zIndex: 1E3,
        box2dType: 1,
        dynamicType: 0,
        density: 1,
        ...
        init: function(b, c, d) {
            this.setupAnim();
            this.parent(b, c, d);
            ig.global.wm || (this.body.SetBullet(!0), this.body.SetAwake(!0), ig.domHandler.getElementById("#canvas").css("cursor",
                "none"), ig.game.sortEntitiesDeferred(), this.createMouseJoint())
        },
        update: function() {
            if (!this.parents.gameOver) {
                this.parent();
                var b = this.body.GetPosition();
                this.body.ApplyForce(new Box2D.Common.Math.b2Vec2(0, this.body.m_mass * -ig.game.gravity * Box2D.SCALE), b);
                b = ig.game.io.getClickPos();
                b = new Box2D.Common.Math.b2Vec2((ig.game.screen.x + b.x) * Box2D.SCALE, ig.ua.mobile ? (ig.game.screen.y + b.y - 130) * Box2D.SCALE : (ig.game.screen.y + b.y) * Box2D.SCALE);
                this.mouseJoint.SetTarget(b)
            }
        },
        setupAnim: function() {
            var b = this.protect;
            ...
            this.size.x = this.animSheet.width;
            this.size.y = this.animSheet.height;
            this.offset.x = this.animSheet.width;
            this.offset.y = this.animSheet.height
        },
        createMouseJoint: function() {
            var b = new Box2D.Dynamics.Joints.b2MouseJointDef;
            b.bodyA = this.parents.balloon.body;
            b.bodyB = this.body;
            var c = this.body.GetPosition(),
                c = new Box2D.Common.Math.b2Vec2(c.x, c.y);
            b.target = c;
            b.maxForce = 1E6 * this.body.GetMass();
            b.dampingRatio = 0.5;
            b.collideConnected = !0;
            this.mouseJoint = ig.world.CreateJoint(b)
        }
    })
});
ig.baked = !0;
ig.module("game.entities.obstacles.circle").requires("plugins.box2d.entity").defines(function() {
    EntityCircle = ig.Box2DEntity.extend({
        ...
        force: 500,
        init: function(b, c, d) {
            this.size.x = this.size.y = d.r ? 2 * d.r : 100;
            this.parent(b, c, d);
        ...
        update: function() {
            this.parent();
            this.pos.y > ig.game.screen.y + ig.system.height && this.kill()
        },
        draw: function() {
            this.parent();
            ig.system.context.save();
            ig.system.context.fillStyle = this.nColor;
            ig.system.context.beginPath();
            if (ig.global.wm) ig.system.context.scale(ig.system.scale, ig.system.scale), ig.system.context.translate(this.pos.x + this.radius - ig.game.screen.x, this.pos.y + this.radius - ig.game.screen.y), ig.system.context.arc(0, 0, this.radius,
                0, this.pi2);
            else {
                var b = this.body.GetPosition();
                ig.system.context.arc(b.x / Box2D.SCALE - ig.game.screen.x, b.y / Box2D.SCALE - ig.game.screen.y, this.radius, 0, this.pi2)
            }
        ...
        check: function(b) {
            if (!ig.game.getEntitiesByType(EntityGameController)[0].gameOver && (this.checkObstacle || b.isProtect) && this.isFixed && !b.isSensor) this.createBody(), this.isFixed = !1
        },
        setVel: function() {
            if (this.isFall && this.isFixed) {
                this.isFixed = !1;
                this.createBody();
                var b = this.body.GetLinearVelocity();
                b.x = this.fallLeft ? -25 : 25;
...
ig.baked = !0;
ig.module("game.entities.obstacles.rectangle").requires("plugins.box2d.entity").defines(function() {
    EntityRectangle = ig.Box2DEntity.extend({
        type: ig.Entity.TYPE.B,
        checkAgainst: ig.Entity.TYPE.BOTH,
        size: {
            x: 70,
        ...
        force: 150,
        init: function(b, c, d) {
            this.size.x = d.w ? d.w : 100;
            this.size.y = d.h ? d.h : 100;
            this.parent(b, c, d);
            ig.global.wm || this.getDetectionShape();
            this.isStatic || ig.world.DestroyBody(this.body);
            ig.game.sortEntitiesDeferred()
        },
        getDetectionShape: function() {
            this.detectionShapePointList = [];
            var b = this.body.GetPosition(),
            ...
            n.x = j - f * d - e * c;
            n.y = b - f * c + e * d;
            this.detectionShapePointList.push(n);
            n = {
                x: 0,
                y: 0
            };
        ...
        draw: function() {
            ...
            ig.system.context.fillStyle = this.nColor;
            ig.system.context.beginPath();
            if (ig.global.wm) ig.system.context.scale(ig.system.scale, ig.system.scale), ig.system.context.rect(this.pos.x - ig.game.screen.x, this.pos.y - ig.game.screen.y, this.size.x, this.size.y);
            else {
                this.getDetectionShape();
                ig.system.context.moveTo(this.detectionShapePointList[0].x -
                    ig.game.screen.x, this.detectionShapePointList[0].y - ig.game.screen.y);
                for (var b = 1, c = this.detectionShapePointList.length; b < c; b++) ig.system.context.lineTo(this.detectionShapePointList[b].x - ig.game.screen.x, this.detectionShapePointList[b].y - ig.game.screen.y);
                ig.system.context.lineTo(this.detectionShapePointList[0].x - ig.game.screen.x, this.detectionShapePointList[0].y - ig.game.screen.y);
                ig.system.context.closePath()
            }
            ig.system.context.fill();
            ig.system.context.restore()
        ...
        check: function(b) {
            var c = ig.game.getEntitiesByType(EntityGameController)[0];
            ig.game.getEntitiesByType(EntityProtect);
            if (!c.gameOver && !this.isStatic && (this.checkObstacle || b.isProtect) && this.isFixed && !b.isSensor) this.createBody(), this.isFixed = !1
        }
    })
});
ig.baked = !0;
ig.module("game.entities.obstacles.obstacle-dynamic").requires("plugins.box2d.entity").defines(function() {
    EntityObstacleDynamic = ig.Box2DEntity.extend({
        type: ig.Entity.TYPE.B,
        checkAgainst: ig.Entity.TYPE.BOTH,
        obstacle: new ig.Image("media/graphics/games/play/obstacles/big-triangle.png"),
        zIndex: 5,
        box2dType: 2,
        dynamicType: 0,
        density: 1,
        ...
        init: function(b, c, d) {
            this.setupAnim();
            this.parent(b, c, d);
            ig.global.wm || (this.isStatic || ig.world.DestroyBody(this.body), ig.game.sortEntitiesDeferred())
        },
        setupAnim: function() {
            var b = this.obstacle;
            this.animSheet = new ig.AnimationSheet(b.path, b.width, b.height);
        ...
        check: function(b) {
            ...
            ig.game.getEntitiesByType(EntityProtect);
            if (!c.gameOver && (this.checkObstacle || b.isProtect) && this.isFixed && !b.isSensor) this.createBody(), this.isFixed = !1
        },
        setVel: function() {
            if (this.isFall && this.isFixed) {
                this.isFixed = !1;
...
ig.baked = !0;
ig.module("game.entities.obstacles.small-triangle").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntitySmallTriangle = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/small-triangle.png"),
        vertices: [{
            x: -0.07,
            y: -4.45
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.big-oval").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityBigOval = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/big-oval.png"),
        vertices: [{
            x: -0.75,
            y: -9.08
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.small-oval").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntitySmallOval = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/small-oval.png"),
        vertices: [{
            x: -0.7,
            y: -4.58
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.plus").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityPlus = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/plus.png"),
        vertices: [{
            x: -0.88,
            y: -2.67
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.pentagon").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityPentagon = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/pentagon.png"),
        vertices: [{
            x: -0.05,
            y: -4.95
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.diamond").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityDiamond = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/diamond.png"),
        vertices: [{
            x: -0.09,
            y: -3.67
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.big-pentagon").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityBigPentagon = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/big-pentagon.png"),
        vertices: [{
            x: -8,
            y: -5.94
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.small-pentagon").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntitySmallPentagon = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/small-pentagon.png"),
        vertices: [{
            x: -3.98,
            y: -3.17
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.big-stars").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntityBigStars = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/big-stars.png"),
        vertices: [{
            x: -6.65,
            y: -2.95
        }, {
...
ig.baked = !0;
ig.module("game.entities.obstacles.small-stars").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntitySmallStars = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/small-stars.png"),
        vertices: [{
            x: 0.02,
            y: -4.91
        }, {
...
ig.baked = !0;
ig.module("game.entities.gentities.sensor").requires("plugins.box2d.entity").defines(function() {
    EntitySensor = ig.Box2DEntity.extend({
        ...
        preSolve: function(b, c) {
            b && (b.isObstacle || b.isProtect) && c.SetEnabled(!1)
        },
        check: function(b) {
            if (this.checkedBalloon) {
                this.checkedBalloon = !1;
                var c = ig.game.getEntitiesByType(EntityObstacleDynamic),
                    d = ig.game.getEntitiesByType(EntityCircle);
                if (b && b.isBalloon && (!c.isFall || !d.isFall)) {
                    ig.game.getEntitiesByType(EntityGameController)[0].spawnNextLevel();
                    for (b = 0; b < c.length; b++) c[b] && c[b].setVel();
                    for (b =
                        0; b < d.length; b++) d[b] && d[b].setVel()
                }
            }
        }
    })
...
ig.baked = !0;
ig.module("game.entities.obstacles.spin").requires("game.entities.obstacles.obstacle-dynamic").defines(function() {
    EntitySpin = EntityObstacleDynamic.extend({
        obstacle: new ig.Image("media/graphics/games/play/obstacles/small-stars.png"),
        vertices: [{
            x: 0.02,
            y: -4.91
        ...
        init: function(b, c, d) {
            ...
            this.moveUpDown && (this.topY = (this.pos.y + this.size.y /
                2 - this.dR) * Box2D.SCALE, this.bottomY = (this.pos.y + this.size.y / 2 + this.dR) * Box2D.SCALE)
        },
        ready: function() {
            if (this.moveUpDown) {
                var b = Math.random();
                0.5 > b ? this.moveUp() : this.moveDown()
            } else this.moveR = ((this.pos.y + this.size.y / 2 + this.dR) * Box2D.SCALE - (this.pos.y + this.size.y / 2 - this.dR) * Box2D.SCALE) / 2, this.speed = 0.7 * Math.PI / 180, b = Math.random(), 0.5 > b && (this.speed = -this.speed), this.ang = 0, this.pos0 = {}, this.pos0.x = this.pos.x * Box2D.SCALE - this.moveR, this.pos0.y = this.pos.y * Box2D.SCALE;
            this.isRotating && (0.5 > Math.random() ?
                this.body.SetAngularVelocity(Math.PI / 3) : this.body.SetAngularVelocity(-Math.PI / 3))
        },
        moveUp: function() {
            var b = this.body.GetLinearVelocity();
            b.y = -(Math.floor(2 * Math.random()) + 8);
            this.body.SetLinearVelocity(b);
            this.isMovingUp = !0
        },
        moveDown: function() {
        ...
        update: function() {
            this.parent();
            if (!this.notMoving)
                if (this.moveUpDown) this.isMovingUp ? this.body.GetPosition().y <= this.topY && this.moveDown() :
                    this.body.GetPosition().y >= this.bottomY && this.moveUp();
                else {
                    this.ang += this.speed;
                    var b = {};
                    b.x = this.pos0.x + this.moveR * Math.cos(this.ang);
                    b.y = this.pos0.y + this.moveR * Math.sin(this.ang);
                    this.body.SetPosition(b)
                }
        }
    })
...
ig.module("game.entities.controllers.game-controller").requires("game.entities.buttons.button-pause", "game.ui.popup-gameover", "game.entities.gentities.rolling-bg", "game.entities.gentities.balloon", "game.entities.gentities.protect", "game.entities.obstacles.circle", "game.entities.obstacles.rectangle", "game.entities.obstacles.small-triangle", "game.entities.obstacles.big-oval", "game.entities.obstacles.small-oval", "game.entities.obstacles.plus", "game.entities.obstacles.pentagon", "game.entities.obstacles.diamond",
    "game.entities.obstacles.big-pentagon", "game.entities.obstacles.small-pentagon", "game.entities.obstacles.big-stars", "game.entities.obstacles.small-stars", "game.entities.gentities.sensor", "game.entities.obstacles.spin").defines(function() {
    EntityGameController = ig.Entity.extend({
        ...
        init: function(b, c, d) {
            ...
            ig.game.currentID = Math.floor(7 *
                Math.random());
            this.resetScore();
            ig.game.spawnEntity(EntityRollingBg, 0, 0);
            this.balloon = this.spawnEntity(EntityBalloon, 210.5, 650);
            this.protect = this.spawnEntity(EntityProtect, 200, 550);
            b = Math.floor(4 * Math.random());
            this.spawObstacle(_LVL[b]);
            ig.game.spawnEntity(EntityFade, 0, 0);
            ig.game.sortEntitiesDeferred()
        },
        addScore: function(b) {
        ...
        draw: function() {
            this.parent();
            ig.game.drawText(_STRINGS.Game.Score, 60, 35, 28, "#000", "center");
            ig.game.drawText(ig.game.score, 105, 35, 28, "#000", "left")
        },
        resetScore: function() {
            ig.game.score =
                0;
        ...
        spawnNextLevel: function() {
            var b = 300 > ig.game.score ? Math.floor(5 * Math.random()) : 600 > ig.game.score ? Math.floor(5 * Math.random() + 5) : 900 > ig.game.score ? Math.floor(5 * Math.random() + 10) : 1200 > ig.game.score ? Math.floor(5 * Math.random() + 15) : 1700 > ig.game.score ? Math.floor(5 * Math.random() + 20) : Math.floor(20 * Math.random() + 5);
            this.spawObstacle(_LVL[b])
        },
        spawObstacle: function(b) {
            for (var c = 0; c < b.length; c++) ig.game.spawnEntity(ig.global[b[c].type], b[c].x, b[c].y + ig.game.screen.y, b[c].settings)
        }
    })
});
ig.baked = !0;
...
ig.baked = !0;
ig.module("game.levels.level1").requires("impact.image", "game.entities.obstacles.circle").defines(function() {
    LevelLevel1 = {
        entities: [{
                type: "EntityCircle",
                x: 115,
...
ig.baked = !0;
ig.module("game.levels.level2").requires("impact.image", "game.entities.obstacles.circle").defines(function() {
    LevelLevel2 = {
        entities: [{
                type: "EntityCircle",
                x: 115,
...
ig.module("game.main").requires("impact.game", "plugins.patches.webkit-image-smoothing-patch", "plugins.patches.windowfocus-onMouseDown-patch", "plugins.handlers.dom-handler", "plugins.handlers.size-handler", "plugins.handlers.api-handler", "plugins.audio.sound-handler", "plugins.io.io-manager", "plugins.io.storage-manager", "plugins.splash-loader", "plugins.tween", "plugins.tweens-handler", "plugins.url-parameters", "plugins.director", "plugins.impact-storage", "plugins.nimpact", "plugins.fullscreen", "plugins.data.vector",
    "plugins.data.color-rgb", "plugins.branding.splash", "game.entities.branding-logo-placeholder", "game.entities.buttons.button-more-games", "plugins.box2d.entity", "plugins.box2d.game", "game.entities.opening-shield", "game.entities.opening-kitty", "game.entities.pointer", "game.entities.select", "game.ui.fade", "game.levels.opening", "game.levels.home", "game.levels.game", "game.levels.level1", "game.levels.level2").defines(function() {
    this.START_OBFUSCATION;
    this.FRAMEBREAKER;
    MyGame = ig.Box2DGame.extend({
        name: "MJS-rise-higher",
        version: "1.0",
        sessionData: {},
        io: null,
        paused: !1,
        ...
        angleBetween: function(b, c) {
            return Math.atan2(c.y - b.y, c.x - b.x)
        },
        distanceBetween: function(b, c) {
            return Math.sqrt(Math.pow(b.y - c.y, 2) + Math.pow(b.x - c.x, 2))
        },
        start: function() {
        ...
        fpsCount: function() {
            ...
            this.fpsTimer && 0 > this.fpsTimer.delta() ? null != this.fpsCounter ? this.fpsCounter++ : this.fpsCounter = 0 : (ig.game.fps =
        ...
        hideOverlay: function(b) {
            for (i = 0; i < b.length; i++) $("#" + b[i]) && $("#" + b[i]).hide(), document.getElementById(b[i]) && (document.getElementById(b[i]).style.visibility =
                "hidden")
        },
        currentBGMVolume: 1,
        addition: 0.1,
